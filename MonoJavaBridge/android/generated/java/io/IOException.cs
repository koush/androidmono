namespace java.io
{
	...
	public partial class IOException : java.lang.Exception
	{
		...
		public IOException() : base(global::MonoJavaBridge.JNIEnv.ThreadEnv)
		{
			...
			if (global::java.io.IOException._IOException19090.native == global::System.IntPtr.Zero)
		...
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (global::java.io.IOException._IOException19091.native == global::System.IntPtr.Zero)
		...
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (global::java.io.IOException._IOException19092.native == global::System.IntPtr.Zero)
		...
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (global::java.io.IOException._IOException19093.native == global::System.IntPtr.Zero)
