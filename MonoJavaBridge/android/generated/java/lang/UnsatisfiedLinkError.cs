namespace java.lang
{
	...
	public partial class UnsatisfiedLinkError : java.lang.LinkageError
	{
		...
		public UnsatisfiedLinkError() : base(global::MonoJavaBridge.JNIEnv.ThreadEnv)
		{
			...
			if (global::java.lang.UnsatisfiedLinkError._UnsatisfiedLinkError20925.native == global::System.IntPtr.Zero)
		...
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (global::java.lang.UnsatisfiedLinkError._UnsatisfiedLinkError20926.native == global::System.IntPtr.Zero)
