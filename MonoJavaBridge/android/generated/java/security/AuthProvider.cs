namespace java.security
{
	...
	public abstract partial class AuthProvider : java.security.Provider
	{
		...
		protected AuthProvider(java.lang.String arg0, double arg1, java.lang.String arg2) : base(global::MonoJavaBridge.JNIEnv.ThreadEnv)
		{
			...
			if (global::java.security.AuthProvider._AuthProvider22901.native == global::System.IntPtr.Zero)
	...
	internal sealed partial class AuthProvider_ : java.security.AuthProvider
	{
		...
		{
			global::MonoJavaBridge.JavaBridge.CallVoidMethod(this, global::java.security.AuthProvider_.staticClass, "login", "(Ljavax/security/auth/Subject;Ljavax/security/auth/callback/CallbackHandler;)V", ref global::java.security.AuthProvider_._login22902, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0), global::MonoJavaBridge.JavaBridge.ConvertToValue(arg1));
		}
		internal static global::MonoJavaBridge.MethodId _logout22903;
		public override void logout()
		{
			global::MonoJavaBridge.JavaBridge.CallVoidMethod(this, global::java.security.AuthProvider_.staticClass, "logout", "()V", ref global::java.security.AuthProvider_._logout22903);
		}
		...
		{
			global::MonoJavaBridge.JavaBridge.CallVoidMethod(this, global::java.security.AuthProvider_.staticClass, "setCallbackHandler", "(Ljavax/security/auth/callback/CallbackHandler;)V", ref global::java.security.AuthProvider_._setCallbackHandler22904, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0));
		}
