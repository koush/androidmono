	...
	internal sealed partial class CertPathValidatorResult_ : java.lang.Object, CertPathValidatorResult
	{
		...
		global::java.lang.Object java.security.cert.CertPathValidatorResult.clone()
		{
			...
			if (!IsClrObject)
				...
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::java.security.cert.CertPathValidatorResult_.staticClass, global::java.security.cert.CertPathValidatorResult_._clone23528)) as java.lang.Object;
		}
