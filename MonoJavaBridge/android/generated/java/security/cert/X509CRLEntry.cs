namespace java.security.cert
{
	...
	public abstract partial class X509CRLEntry : java.lang.Object, X509Extension
	{
		...
		public override bool equals(java.lang.Object arg0)
		{
			...
			if (!IsClrObject)
				return @__env.CallBooleanMethod(this.JvmHandle, global::java.security.cert.X509CRLEntry._equals23748, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0));
			else
				return @__env.CallNonVirtualBooleanMethod(this.JvmHandle, global::java.security.cert.X509CRLEntry.staticClass, global::java.security.cert.X509CRLEntry._equals23748, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0));
		}
		...
		public override int hashCode()
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (!IsClrObject)
				return @__env.CallIntMethod(this.JvmHandle, global::java.security.cert.X509CRLEntry._hashCode23750);
			else
				return @__env.CallNonVirtualIntMethod(this.JvmHandle, global::java.security.cert.X509CRLEntry.staticClass, global::java.security.cert.X509CRLEntry._hashCode23750);
		}
		...
		public virtual global::javax.security.auth.x500.X500Principal getCertificateIssuer()
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapJavaObjectSealedClass<javax.security.auth.x500.X500Principal>(@__env.CallObjectMethod(this.JvmHandle, global::java.security.cert.X509CRLEntry._getCertificateIssuer23753)) as javax.security.auth.x500.X500Principal;
			else
	...
	internal sealed partial class X509CRLEntry_ : java.security.cert.X509CRLEntry
	{
		...
		public override bool hasUnsupportedCriticalExtension()
		{
			...
			if (!IsClrObject)
				...
				return @__env.CallNonVirtualBooleanMethod(this.JvmHandle, global::java.security.cert.X509CRLEntry_.staticClass, global::java.security.cert.X509CRLEntry_._hasUnsupportedCriticalExtension23757);
		}
		...
		public override global::java.util.Set getCriticalExtensionOIDs()
		{
			...
			if (!IsClrObject)
				...
				return global::MonoJavaBridge.JavaBridge.WrapIJavaObject<global::java.util.Set>(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::java.security.cert.X509CRLEntry_.staticClass, global::java.security.cert.X509CRLEntry_._getCriticalExtensionOIDs23758)) as java.util.Set;
		}
		...
		public override global::java.util.Set getNonCriticalExtensionOIDs()
		{
			...
			if (!IsClrObject)
				...
				return global::MonoJavaBridge.JavaBridge.WrapIJavaObject<global::java.util.Set>(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::java.security.cert.X509CRLEntry_.staticClass, global::java.security.cert.X509CRLEntry_._getNonCriticalExtensionOIDs23759)) as java.util.Set;
		}
		...
		public override byte[] getExtensionValue(java.lang.String arg0)
		{
			...
			if (!IsClrObject)
				...
				return global::MonoJavaBridge.JavaBridge.WrapJavaArrayObject<byte>(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::java.security.cert.X509CRLEntry_.staticClass, global::java.security.cert.X509CRLEntry_._getExtensionValue23760, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0))) as byte[];
		}
		...
		public override global::java.lang.String toString()
		{
			...
			if (!IsClrObject)
				...
				return global::MonoJavaBridge.JavaBridge.WrapJavaObjectSealedClass<java.lang.String>(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::java.security.cert.X509CRLEntry_.staticClass, global::java.security.cert.X509CRLEntry_._toString23761)) as java.lang.String;
		}
		...
		public override byte[] getEncoded()
		{
			...
			if (!IsClrObject)
				...
				return global::MonoJavaBridge.JavaBridge.WrapJavaArrayObject<byte>(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::java.security.cert.X509CRLEntry_.staticClass, global::java.security.cert.X509CRLEntry_._getEncoded23762)) as byte[];
		}
		...
		public override global::java.math.BigInteger getSerialNumber()
		{
			...
			if (!IsClrObject)
				...
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::java.security.cert.X509CRLEntry_.staticClass, global::java.security.cert.X509CRLEntry_._getSerialNumber23763)) as java.math.BigInteger;
		}
		...
		public override global::java.util.Date getRevocationDate()
		{
			...
			if (!IsClrObject)
				...
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::java.security.cert.X509CRLEntry_.staticClass, global::java.security.cert.X509CRLEntry_._getRevocationDate23764)) as java.util.Date;
		}
