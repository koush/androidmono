namespace java.sql
{
	...
	internal sealed partial class Driver_ : java.lang.Object, Driver
	{
		...
		global::java.sql.Connection java.sql.Driver.connect(java.lang.String arg0, java.util.Properties arg1)
		{
			...
			if (global::java.sql.Driver_._connect24620.native == global::System.IntPtr.Zero)
		...
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (global::java.sql.Driver_._acceptsURL24621.native == global::System.IntPtr.Zero)
		...
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (global::java.sql.Driver_._getPropertyInfo24622.native == global::System.IntPtr.Zero)
		...
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (global::java.sql.Driver_._getMajorVersion24623.native == global::System.IntPtr.Zero)
		...
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (global::java.sql.Driver_._getMinorVersion24624.native == global::System.IntPtr.Zero)
		...
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (global::java.sql.Driver_._jdbcCompliant24625.native == global::System.IntPtr.Zero)
