namespace java.sql
{
	...
	internal sealed partial class Ref_ : java.lang.Object, Ref
	{
		...
		global::java.lang.Object java.sql.Ref.getObject(java.util.Map arg0)
		{
			...
			if (global::java.sql.Ref_._getObject24754.native == global::System.IntPtr.Zero)
		...
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (global::java.sql.Ref_._getObject24755.native == global::System.IntPtr.Zero)
		...
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (global::java.sql.Ref_._setObject24756.native == global::System.IntPtr.Zero)
		...
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (global::java.sql.Ref_._getBaseTypeName24757.native == global::System.IntPtr.Zero)
