	...
	internal sealed partial class Ref_ : java.lang.Object, Ref
	{
		...
		global::java.lang.Object java.sql.Ref.getObject(java.util.Map arg0)
		{
			...
			if (!IsClrObject)
				...
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::java.sql.Ref_.staticClass, global::java.sql.Ref_._getObject24754, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0))) as java.lang.Object;
		}
		...
		global::java.lang.Object java.sql.Ref.getObject()
		{
			...
			if (!IsClrObject)
				...
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::java.sql.Ref_.staticClass, global::java.sql.Ref_._getObject24755)) as java.lang.Object;
		}
		...
		void java.sql.Ref.setObject(java.lang.Object arg0)
		{
			...
			if (!IsClrObject)
				...
				@__env.CallNonVirtualVoidMethod(this.JvmHandle, global::java.sql.Ref_.staticClass, global::java.sql.Ref_._setObject24756, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0));
		}
