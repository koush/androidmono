	...
	internal sealed partial class LoggingMXBean_ : java.lang.Object, LoggingMXBean
	{
		...
		global::java.util.List java.util.logging.LoggingMXBean.getLoggerNames()
		{
			...
			if (!IsClrObject)
				...
				return global::MonoJavaBridge.JavaBridge.WrapIJavaObject<global::java.util.List>(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::java.util.logging.LoggingMXBean_.staticClass, global::java.util.logging.LoggingMXBean_._getLoggerNames28084)) as java.util.List;
		}
		...
		void java.util.logging.LoggingMXBean.setLoggerLevel(java.lang.String arg0, java.lang.String arg1)
		{
			...
			if (!IsClrObject)
				...
				@__env.CallNonVirtualVoidMethod(this.JvmHandle, global::java.util.logging.LoggingMXBean_.staticClass, global::java.util.logging.LoggingMXBean_._setLoggerLevel28086, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0), global::MonoJavaBridge.JavaBridge.ConvertToValue(arg1));
		}
