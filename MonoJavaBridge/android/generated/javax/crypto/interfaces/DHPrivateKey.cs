namespace javax.crypto.interfaces
{
	...
	internal sealed partial class DHPrivateKey_ : java.lang.Object, DHPrivateKey
	{
		...
		global::java.math.BigInteger javax.crypto.interfaces.DHPrivateKey.getX()
		{
			...
			if (global::javax.crypto.interfaces.DHPrivateKey_._getX28737.native == global::System.IntPtr.Zero)
		...
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (global::javax.crypto.interfaces.DHPrivateKey_._getParams28738.native == global::System.IntPtr.Zero)
		...
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (global::javax.crypto.interfaces.DHPrivateKey_._getEncoded28739.native == global::System.IntPtr.Zero)
		...
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (global::javax.crypto.interfaces.DHPrivateKey_._getAlgorithm28740.native == global::System.IntPtr.Zero)
		...
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (global::javax.crypto.interfaces.DHPrivateKey_._getFormat28741.native == global::System.IntPtr.Zero)
