	...
	internal sealed partial class Source_ : java.lang.Object, Source
	{
		...
		global::java.lang.String javax.xml.transform.Source.getSystemId()
		{
			...
			if (!IsClrObject)
				...
				return global::MonoJavaBridge.JavaBridge.WrapJavaObjectSealedClass<java.lang.String>(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::javax.xml.transform.Source_.staticClass, global::javax.xml.transform.Source_._getSystemId30951)) as java.lang.String;
		}
		...
		void javax.xml.transform.Source.setSystemId(java.lang.String arg0)
		{
			...
			if (!IsClrObject)
				...
				@__env.CallNonVirtualVoidMethod(this.JvmHandle, global::javax.xml.transform.Source_.staticClass, global::javax.xml.transform.Source_._setSystemId30952, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0));
		}
		static Source_()
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
