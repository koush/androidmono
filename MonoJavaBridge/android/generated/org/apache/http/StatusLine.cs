namespace org.apache.http
{
	...
	internal sealed partial class StatusLine_ : java.lang.Object, StatusLine
	{
		...
		global::org.apache.http.ProtocolVersion org.apache.http.StatusLine.getProtocolVersion()
		{
			...
			if (global::org.apache.http.StatusLine_._getProtocolVersion31763.native == global::System.IntPtr.Zero)
		...
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (global::org.apache.http.StatusLine_._getStatusCode31764.native == global::System.IntPtr.Zero)
		...
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (global::org.apache.http.StatusLine_._getReasonPhrase31765.native == global::System.IntPtr.Zero)
