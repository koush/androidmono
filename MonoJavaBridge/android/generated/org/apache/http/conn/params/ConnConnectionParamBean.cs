namespace org.apache.http.conn.@params
{
	...
	public partial class ConnConnectionParamBean : org.apache.http.@params.HttpAbstractParamBean
	{
		...
		public virtual void setMaxStatusLineGarbage(int arg0)
		{
			...
			if (!IsClrObject)
				@__env.CallVoidMethod(this.JvmHandle, global::org.apache.http.conn.@params.ConnConnectionParamBean._setMaxStatusLineGarbage32174, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0));
			else
				@__env.CallNonVirtualVoidMethod(this.JvmHandle, global::org.apache.http.conn.@params.ConnConnectionParamBean.staticClass, global::org.apache.http.conn.@params.ConnConnectionParamBean._setMaxStatusLineGarbage32174, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0));
		}
