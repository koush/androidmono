namespace org.apache.http.impl.auth
{
	...
	public partial class DigestSchemeFactory : java.lang.Object, org.apache.http.auth.AuthSchemeFactory
	{
		...
		{
			return global::MonoJavaBridge.JavaBridge.CallIJavaObjectMethod<org.apache.http.auth.AuthScheme>(this, global::org.apache.http.impl.auth.DigestSchemeFactory.staticClass, "newInstance", "(Lorg/apache/http/params/HttpParams;)Lorg/apache/http/auth/AuthScheme;", ref global::org.apache.http.impl.auth.DigestSchemeFactory._newInstance32735, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0)) as org.apache.http.auth.AuthScheme;
		}
		...
		public DigestSchemeFactory() : base(global::MonoJavaBridge.JNIEnv.ThreadEnv)
		{
			...
			if (global::org.apache.http.impl.auth.DigestSchemeFactory._DigestSchemeFactory32736.native == global::System.IntPtr.Zero)
