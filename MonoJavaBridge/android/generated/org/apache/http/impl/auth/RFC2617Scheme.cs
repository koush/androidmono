namespace org.apache.http.impl.auth
{
	...
	public abstract partial class RFC2617Scheme : org.apache.http.impl.auth.AuthSchemeBase
	{
		...
		{
			return global::MonoJavaBridge.JavaBridge.CallIJavaObjectMethod<java.util.Map>(this, global::org.apache.http.impl.auth.RFC2617Scheme.staticClass, "getParameters", "()Ljava/util/Map;", ref global::org.apache.http.impl.auth.RFC2617Scheme._getParameters32750) as java.util.Map;
		}
		...
		{
			return global::MonoJavaBridge.JavaBridge.CallSealedClassObjectMethod<java.lang.String>(this, global::org.apache.http.impl.auth.RFC2617Scheme.staticClass, "getParameter", "(Ljava/lang/String;)Ljava/lang/String;", ref global::org.apache.http.impl.auth.RFC2617Scheme._getParameter32751, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0)) as java.lang.String;
		}
		internal static global::MonoJavaBridge.MethodId _getRealm32752;
		public override global::java.lang.String getRealm()
		{
			return global::MonoJavaBridge.JavaBridge.CallSealedClassObjectMethod<java.lang.String>(this, global::org.apache.http.impl.auth.RFC2617Scheme.staticClass, "getRealm", "()Ljava/lang/String;", ref global::org.apache.http.impl.auth.RFC2617Scheme._getRealm32752) as java.lang.String;
		}
		...
		{
			global::MonoJavaBridge.JavaBridge.CallVoidMethod(this, global::org.apache.http.impl.auth.RFC2617Scheme.staticClass, "parseChallenge", "(Lorg/apache/http/util/CharArrayBuffer;II)V", ref global::org.apache.http.impl.auth.RFC2617Scheme._parseChallenge32753, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0), global::MonoJavaBridge.JavaBridge.ConvertToValue(arg1), global::MonoJavaBridge.JavaBridge.ConvertToValue(arg2));
		}
	...
	internal sealed partial class RFC2617Scheme_ : org.apache.http.impl.auth.RFC2617Scheme
	{
		...
		{
			return global::MonoJavaBridge.JavaBridge.CallSealedClassObjectMethod<java.lang.String>(this, global::org.apache.http.impl.auth.RFC2617Scheme_.staticClass, "getSchemeName", "()Ljava/lang/String;", ref global::org.apache.http.impl.auth.RFC2617Scheme_._getSchemeName32755) as java.lang.String;
		}
		internal static global::MonoJavaBridge.MethodId _isConnectionBased32756;
		public override bool isConnectionBased()
		{
			return global::MonoJavaBridge.JavaBridge.CallBooleanMethod(this, global::org.apache.http.impl.auth.RFC2617Scheme_.staticClass, "isConnectionBased", "()Z", ref global::org.apache.http.impl.auth.RFC2617Scheme_._isConnectionBased32756);
		}
		internal static global::MonoJavaBridge.MethodId _isComplete32757;
		public override bool isComplete()
		{
			return global::MonoJavaBridge.JavaBridge.CallBooleanMethod(this, global::org.apache.http.impl.auth.RFC2617Scheme_.staticClass, "isComplete", "()Z", ref global::org.apache.http.impl.auth.RFC2617Scheme_._isComplete32757);
		}
		...
		{
			return global::MonoJavaBridge.JavaBridge.CallIJavaObjectMethod<org.apache.http.Header>(this, global::org.apache.http.impl.auth.RFC2617Scheme_.staticClass, "authenticate", "(Lorg/apache/http/auth/Credentials;Lorg/apache/http/HttpRequest;)Lorg/apache/http/Header;", ref global::org.apache.http.impl.auth.RFC2617Scheme_._authenticate32758, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0), global::MonoJavaBridge.JavaBridge.ConvertToValue(arg1)) as org.apache.http.Header;
		}
