namespace android.content
{
	...
	public partial class SyncContext : java.lang.Object
	{
		...
		public virtual void onFinished(android.content.SyncResult arg0)
		{
			...
			if (!IsClrObject)
				@__env.CallVoidMethod(this.JvmHandle, global::android.content.SyncContext._onFinished3546, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0));
			else
				@__env.CallNonVirtualVoidMethod(this.JvmHandle, global::android.content.SyncContext.staticClass, global::android.content.SyncContext._onFinished3546, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0));
		}
		...
		public virtual global::android.os.IBinder getSyncContextBinder()
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapIJavaObject<global::android.os.IBinder>(@__env.CallObjectMethod(this.JvmHandle, global::android.content.SyncContext._getSyncContextBinder3547)) as android.os.IBinder;
			else
				return global::MonoJavaBridge.JavaBridge.WrapIJavaObject<global::android.os.IBinder>(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::android.content.SyncContext.staticClass, global::android.content.SyncContext._getSyncContextBinder3547)) as android.os.IBinder;
		}
		static SyncContext()
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
