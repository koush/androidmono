namespace android.content
{
	...
	public sealed partial class SyncStatusObserver_ : java.lang.Object, SyncStatusObserver
	{
		...
		internal static global::MonoJavaBridge.MethodId _onStatusChanged3572;
		 void android.content.SyncStatusObserver.onStatusChanged(int arg0) 
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (!IsClrObject)
				@__env.CallVoidMethod(this.JvmHandle, global::android.content.SyncStatusObserver_._onStatusChanged3572, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0));
			else
				@__env.CallNonVirtualVoidMethod(this.JvmHandle, global::android.content.SyncStatusObserver_.staticClass, global::android.content.SyncStatusObserver_._onStatusChanged3572, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0));
		}
		private static void InitJNI()
		{
			...
			global::android.content.SyncStatusObserver_._onStatusChanged3572 = @__env.GetMethodIDNoThrow(global::android.content.SyncStatusObserver_.staticClass, "onStatusChanged", "(I)V");
		}
	}
}
