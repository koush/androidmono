namespace android.os
{
	...
	public sealed partial class IBinder_DeathRecipient_ : java.lang.Object, IBinder_DeathRecipient
	{
		...
		internal static global::MonoJavaBridge.MethodId _binderDied6461;
		 void android.os.IBinder_DeathRecipient.binderDied() 
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (!IsClrObject)
				@__env.CallVoidMethod(this.JvmHandle, global::android.os.IBinder_DeathRecipient_._binderDied6461);
			else
				@__env.CallNonVirtualVoidMethod(this.JvmHandle, global::android.os.IBinder_DeathRecipient_.staticClass, global::android.os.IBinder_DeathRecipient_._binderDied6461);
		}
		private static void InitJNI()
		{
			...
			global::android.os.IBinder_DeathRecipient_._binderDied6461 = @__env.GetMethodIDNoThrow(global::android.os.IBinder_DeathRecipient_.staticClass, "binderDied", "()V");
		}
	}
}
