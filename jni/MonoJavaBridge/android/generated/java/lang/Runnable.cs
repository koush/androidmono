namespace java.lang
{
	...
	public sealed partial class Runnable_ : java.lang.Object, Runnable
	{
		...
		internal static global::MonoJavaBridge.MethodId _run13106;
		 void java.lang.Runnable.run() 
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (!IsClrObject)
				@__env.CallVoidMethod(this.JvmHandle, global::java.lang.Runnable_._run13106);
			else
				@__env.CallNonVirtualVoidMethod(this.JvmHandle, global::java.lang.Runnable_.staticClass, global::java.lang.Runnable_._run13106);
		}
		private static void InitJNI()
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			global::java.lang.Runnable_.staticClass = @__env.NewGlobalRef(@__env.FindClass("java/lang/Runnable"));
			global::java.lang.Runnable_._run13106 = @__env.GetMethodIDNoThrow(global::java.lang.Runnable_.staticClass, "run", "()V");
		}
	}
}
