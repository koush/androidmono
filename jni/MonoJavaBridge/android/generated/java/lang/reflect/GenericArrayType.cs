namespace java.lang.reflect
{
	...
	internal sealed partial class GenericArrayType_ : java.lang.Object, GenericArrayType
	{
		 ...
		 global::java.lang.reflect.Type java.lang.reflect.GenericArrayType.getGenericComponentType() 
		{
			...
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapIJavaObject<global::java.lang.reflect.Type>(@__env.CallObjectMethod(this.JvmHandle, global::java.lang.reflect.GenericArrayType_._getGenericComponentType21080)) as java.lang.reflect.Type;
			else
				return global::MonoJavaBridge.JavaBridge.WrapIJavaObject<global::java.lang.reflect.Type>(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::java.lang.reflect.GenericArrayType_.staticClass, global::java.lang.reflect.GenericArrayType_._getGenericComponentType21080)) as java.lang.reflect.Type;
		}
		private static void InitJNI()
		{
			...
			global::java.lang.reflect.GenericArrayType_._getGenericComponentType21080 = @__env.GetMethodIDNoThrow(global::java.lang.reflect.GenericArrayType_.staticClass, "getGenericComponentType", "()Ljava/lang/reflect/Type;");
		}
	}
}
