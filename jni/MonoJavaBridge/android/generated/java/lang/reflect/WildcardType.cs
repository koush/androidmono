namespace java.lang.reflect
{
	...
	internal sealed partial class WildcardType_ : java.lang.Object, WildcardType
	{
		...
		global::java.lang.reflect.Type[] java.lang.reflect.WildcardType.getUpperBounds()
		{
			...
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapJavaArrayObject<java.lang.reflect.Type>(@__env.CallObjectMethod(this.JvmHandle, global::java.lang.reflect.WildcardType_._getUpperBounds21161)) as java.lang.reflect.Type[];
			else
		...
		global::java.lang.reflect.Type[] java.lang.reflect.WildcardType.getLowerBounds()
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapJavaArrayObject<java.lang.reflect.Type>(@__env.CallObjectMethod(this.JvmHandle, global::java.lang.reflect.WildcardType_._getLowerBounds21162)) as java.lang.reflect.Type[];
			else
				return global::MonoJavaBridge.JavaBridge.WrapJavaArrayObject<java.lang.reflect.Type>(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::java.lang.reflect.WildcardType_.staticClass, global::java.lang.reflect.WildcardType_._getLowerBounds21162)) as java.lang.reflect.Type[];
		}
		private static void InitJNI()
		{
			...
			global::java.lang.reflect.WildcardType_._getUpperBounds21161 = @__env.GetMethodIDNoThrow(global::java.lang.reflect.WildcardType_.staticClass, "getUpperBounds", "()[Ljava/lang/reflect/Type;");
			global::java.lang.reflect.WildcardType_._getLowerBounds21162 = @__env.GetMethodIDNoThrow(global::java.lang.reflect.WildcardType_.staticClass, "getLowerBounds", "()[Ljava/lang/reflect/Type;");
		}
	}
}
