namespace java.net
{
	...
	public abstract partial class CacheResponse : java.lang.Object
	{
		...
		internal static global::MonoJavaBridge.MethodId _getHeaders21353;
		...
		private static void InitJNI()
		{
			...
			global::java.net.CacheResponse._getHeaders21353 = @__env.GetMethodIDNoThrow(global::java.net.CacheResponse.staticClass, "getHeaders", "()Ljava/util/Map;");
			global::java.net.CacheResponse._getBody21354 = @__env.GetMethodIDNoThrow(global::java.net.CacheResponse.staticClass, "getBody", "()Ljava/io/InputStream;");
			global::java.net.CacheResponse._CacheResponse21355 = @__env.GetMethodIDNoThrow(global::java.net.CacheResponse.staticClass, "<init>", "()V");
		}
	}
	...
	internal sealed partial class CacheResponse_ : java.net.CacheResponse
	{
		...
		public override global::java.util.Map getHeaders() 
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapIJavaObject<global::java.util.Map>(@__env.CallObjectMethod(this.JvmHandle, global::java.net.CacheResponse_._getHeaders21356)) as java.util.Map;
			else
		...
		public override global::java.io.InputStream getBody() 
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallObjectMethod(this.JvmHandle, global::java.net.CacheResponse_._getBody21357)) as java.io.InputStream;
			else
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::java.net.CacheResponse_.staticClass, global::java.net.CacheResponse_._getBody21357)) as java.io.InputStream;
		}
		private static void InitJNI()
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			global::java.net.CacheResponse_.staticClass = @__env.NewGlobalRef(@__env.FindClass("java/net/CacheResponse"));
			global::java.net.CacheResponse_._getHeaders21356 = @__env.GetMethodIDNoThrow(global::java.net.CacheResponse_.staticClass, "getHeaders", "()Ljava/util/Map;");
			global::java.net.CacheResponse_._getBody21357 = @__env.GetMethodIDNoThrow(global::java.net.CacheResponse_.staticClass, "getBody", "()Ljava/io/InputStream;");
		}
	}
}
