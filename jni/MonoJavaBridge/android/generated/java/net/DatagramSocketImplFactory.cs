namespace java.net
{
	...
	internal sealed partial class DatagramSocketImplFactory_ : java.lang.Object, DatagramSocketImplFactory
	{
		...
		global::java.net.DatagramSocketImpl java.net.DatagramSocketImplFactory.createDatagramSocketImpl()
		{
			...
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallObjectMethod(this.JvmHandle, global::java.net.DatagramSocketImplFactory_._createDatagramSocketImpl21464)) as java.net.DatagramSocketImpl;
			else
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::java.net.DatagramSocketImplFactory_.staticClass, global::java.net.DatagramSocketImplFactory_._createDatagramSocketImpl21464)) as java.net.DatagramSocketImpl;
		}
		private static void InitJNI()
		{
			...
			global::java.net.DatagramSocketImplFactory_._createDatagramSocketImpl21464 = @__env.GetMethodIDNoThrow(global::java.net.DatagramSocketImplFactory_.staticClass, "createDatagramSocketImpl", "()Ljava/net/DatagramSocketImpl;");
		}
	}
}
