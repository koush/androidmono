namespace java.net
{
	...
	public partial class HttpRetryException : java.io.IOException
	{
		...
		public virtual global::java.lang.String getLocation() 
		{
			...
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallObjectMethod(this.JvmHandle, global::java.net.HttpRetryException._getLocation21348)) as java.lang.String;
			else
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::java.net.HttpRetryException.staticClass, global::java.net.HttpRetryException._getLocation21348)) as java.lang.String;
		}
		...
		public virtual global::java.lang.String getReason() 
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallObjectMethod(this.JvmHandle, global::java.net.HttpRetryException._getReason21349)) as java.lang.String;
			else
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::java.net.HttpRetryException.staticClass, global::java.net.HttpRetryException._getReason21349)) as java.lang.String;
		}
