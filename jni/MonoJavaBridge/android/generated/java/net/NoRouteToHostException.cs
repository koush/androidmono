namespace java.net
{
	...
	public partial class NoRouteToHostException : java.net.SocketException
	{
		...
		private static void InitJNI()
		{
			...
			global::java.net.NoRouteToHostException._NoRouteToHostException21649 = @__env.GetMethodIDNoThrow(global::java.net.NoRouteToHostException.staticClass, "<init>", "(Ljava/lang/String;)V");
			global::java.net.NoRouteToHostException._NoRouteToHostException21650 = @__env.GetMethodIDNoThrow(global::java.net.NoRouteToHostException.staticClass, "<init>", "()V");
		}
	}
}
