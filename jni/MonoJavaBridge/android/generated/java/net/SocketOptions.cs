namespace java.net
{
	...
	internal sealed partial class SocketOptions_ : java.lang.Object, SocketOptions
	{
		 ...
		 global::java.lang.Object java.net.SocketOptions.getOption(int arg0) 
		{
			...
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallObjectMethod(this.JvmHandle, global::java.net.SocketOptions_._getOption21814, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0))) as java.lang.Object;
			else
		 ...
		 void java.net.SocketOptions.setOption(int arg0, java.lang.Object arg1) 
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (!IsClrObject)
				@__env.CallVoidMethod(this.JvmHandle, global::java.net.SocketOptions_._setOption21815, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0), global::MonoJavaBridge.JavaBridge.ConvertToValue(arg1));
			else
				@__env.CallNonVirtualVoidMethod(this.JvmHandle, global::java.net.SocketOptions_.staticClass, global::java.net.SocketOptions_._setOption21815, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0), global::MonoJavaBridge.JavaBridge.ConvertToValue(arg1));
		}
		private static void InitJNI()
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			global::java.net.SocketOptions_.staticClass = @__env.NewGlobalRef(@__env.FindClass("java/net/SocketOptions"));
			global::java.net.SocketOptions_._getOption21814 = @__env.GetMethodIDNoThrow(global::java.net.SocketOptions_.staticClass, "getOption", "(I)Ljava/lang/Object;");
			global::java.net.SocketOptions_._setOption21815 = @__env.GetMethodIDNoThrow(global::java.net.SocketOptions_.staticClass, "setOption", "(ILjava/lang/Object;)V");
		}
	}
}
