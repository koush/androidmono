namespace java.net
{
	...
	public sealed partial class URLStreamHandlerFactory_ : java.lang.Object, URLStreamHandlerFactory
	{
		...
		internal static global::MonoJavaBridge.MethodId _createURLStreamHandler21871;
		 global::java.net.URLStreamHandler java.net.URLStreamHandlerFactory.createURLStreamHandler(java.lang.String arg0) 
		{
			...
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallObjectMethod(this.JvmHandle, global::java.net.URLStreamHandlerFactory_._createURLStreamHandler21871, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0))) as java.net.URLStreamHandler;
			else
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::java.net.URLStreamHandlerFactory_.staticClass, global::java.net.URLStreamHandlerFactory_._createURLStreamHandler21871, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0))) as java.net.URLStreamHandler;
		}
		private static void InitJNI()
		{
			...
			global::java.net.URLStreamHandlerFactory_._createURLStreamHandler21871 = @__env.GetMethodIDNoThrow(global::java.net.URLStreamHandlerFactory_.staticClass, "createURLStreamHandler", "(Ljava/lang/String;)Ljava/net/URLStreamHandler;");
		}
	}
}
