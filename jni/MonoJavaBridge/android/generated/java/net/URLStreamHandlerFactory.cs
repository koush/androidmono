namespace java.net
{
	...
	internal sealed partial class URLStreamHandlerFactory_ : java.lang.Object, URLStreamHandlerFactory
	{
		 ...
		 global::java.net.URLStreamHandler java.net.URLStreamHandlerFactory.createURLStreamHandler(java.lang.String arg0) 
		{
			...
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallObjectMethod(this.JvmHandle, global::java.net.URLStreamHandlerFactory_._createURLStreamHandler21989, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0))) as java.net.URLStreamHandler;
			else
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::java.net.URLStreamHandlerFactory_.staticClass, global::java.net.URLStreamHandlerFactory_._createURLStreamHandler21989, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0))) as java.net.URLStreamHandler;
		}
		private static void InitJNI()
		{
			...
			global::java.net.URLStreamHandlerFactory_._createURLStreamHandler21989 = @__env.GetMethodIDNoThrow(global::java.net.URLStreamHandlerFactory_.staticClass, "createURLStreamHandler", "(Ljava/lang/String;)Ljava/net/URLStreamHandler;");
		}
	}
}
