namespace java.security
{
	...
	public abstract partial class AuthProvider : java.security.Provider
	{
		...
		internal static global::MonoJavaBridge.MethodId _login22897;
		public abstract void login(javax.security.auth.Subject arg0, javax.security.auth.callback.CallbackHandler arg1);
		internal static global::MonoJavaBridge.MethodId _logout22898;
		...
		private static void InitJNI()
		{
			...
			global::java.security.AuthProvider._login22897 = @__env.GetMethodIDNoThrow(global::java.security.AuthProvider.staticClass, "login", "(Ljavax/security/auth/Subject;Ljavax/security/auth/callback/CallbackHandler;)V");
			global::java.security.AuthProvider._logout22898 = @__env.GetMethodIDNoThrow(global::java.security.AuthProvider.staticClass, "logout", "()V");
			global::java.security.AuthProvider._setCallbackHandler22899 = @__env.GetMethodIDNoThrow(global::java.security.AuthProvider.staticClass, "setCallbackHandler", "(Ljavax/security/auth/callback/CallbackHandler;)V");
			global::java.security.AuthProvider._AuthProvider22900 = @__env.GetMethodIDNoThrow(global::java.security.AuthProvider.staticClass, "<init>", "(Ljava/lang/String;DLjava/lang/String;)V");
		}
	}
	...
	internal sealed partial class AuthProvider_ : java.security.AuthProvider
	{
		...
		public override void login(javax.security.auth.Subject arg0, javax.security.auth.callback.CallbackHandler arg1)
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (!IsClrObject)
				@__env.CallVoidMethod(this.JvmHandle, global::java.security.AuthProvider_._login22901, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0), global::MonoJavaBridge.JavaBridge.ConvertToValue(arg1));
			else
		...
		public override void logout()
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (!IsClrObject)
				@__env.CallVoidMethod(this.JvmHandle, global::java.security.AuthProvider_._logout22902);
			else
		...
		public override void setCallbackHandler(javax.security.auth.callback.CallbackHandler arg0)
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (!IsClrObject)
				@__env.CallVoidMethod(this.JvmHandle, global::java.security.AuthProvider_._setCallbackHandler22903, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0));
			else
				@__env.CallNonVirtualVoidMethod(this.JvmHandle, global::java.security.AuthProvider_.staticClass, global::java.security.AuthProvider_._setCallbackHandler22903, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0));
		}
		private static void InitJNI()
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			global::java.security.AuthProvider_.staticClass = @__env.NewGlobalRef(@__env.FindClass("java/security/AuthProvider"));
			global::java.security.AuthProvider_._login22901 = @__env.GetMethodIDNoThrow(global::java.security.AuthProvider_.staticClass, "login", "(Ljavax/security/auth/Subject;Ljavax/security/auth/callback/CallbackHandler;)V");
			global::java.security.AuthProvider_._logout22902 = @__env.GetMethodIDNoThrow(global::java.security.AuthProvider_.staticClass, "logout", "()V");
			global::java.security.AuthProvider_._setCallbackHandler22903 = @__env.GetMethodIDNoThrow(global::java.security.AuthProvider_.staticClass, "setCallbackHandler", "(Ljavax/security/auth/callback/CallbackHandler;)V");
		}
	}
}
