	...
	internal sealed partial class Certificate_ : java.lang.Object, Certificate
	{
		...
		global::java.lang.String java.security.Certificate.toString(bool arg0)
		{
			...
			if (!IsClrObject)
				...
				return global::MonoJavaBridge.JavaBridge.WrapJavaObjectSealedClass<java.lang.String>(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::java.security.Certificate_.staticClass, global::java.security.Certificate_._toString22912, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0))) as java.lang.String;
		}
		...
		void java.security.Certificate.decode(java.io.InputStream arg0)
		{
			...
			if (!IsClrObject)
				...
				@__env.CallNonVirtualVoidMethod(this.JvmHandle, global::java.security.Certificate_.staticClass, global::java.security.Certificate_._decode22913, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0));
		}
		...
		void java.security.Certificate.encode(java.io.OutputStream arg0)
		{
			...
			if (!IsClrObject)
				...
				@__env.CallNonVirtualVoidMethod(this.JvmHandle, global::java.security.Certificate_.staticClass, global::java.security.Certificate_._encode22914, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0));
		}
		...
		global::java.security.PublicKey java.security.Certificate.getPublicKey()
		{
			...
			if (!IsClrObject)
				...
				return global::MonoJavaBridge.JavaBridge.WrapIJavaObject<global::java.security.PublicKey>(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::java.security.Certificate_.staticClass, global::java.security.Certificate_._getPublicKey22915)) as java.security.PublicKey;
		}
		...
		global::java.lang.String java.security.Certificate.getFormat()
		{
			...
			if (!IsClrObject)
				...
				return global::MonoJavaBridge.JavaBridge.WrapJavaObjectSealedClass<java.lang.String>(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::java.security.Certificate_.staticClass, global::java.security.Certificate_._getFormat22916)) as java.lang.String;
		}
		...
		global::java.security.Principal java.security.Certificate.getGuarantor()
		{
			...
			if (!IsClrObject)
				...
				return global::MonoJavaBridge.JavaBridge.WrapIJavaObject<global::java.security.Principal>(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::java.security.Certificate_.staticClass, global::java.security.Certificate_._getGuarantor22917)) as java.security.Principal;
		}
