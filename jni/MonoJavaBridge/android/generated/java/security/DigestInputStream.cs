namespace java.security
{
	...
	public partial class DigestInputStream : java.io.FilterInputStream
	{
		...
		public override global::java.lang.String toString() 
		{
			...
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapJavaObjectSealedClass<java.lang.String>(@__env.CallObjectMethod(this.JvmHandle, global::java.security.DigestInputStream._toString22937)) as java.lang.String;
			else
		...
		public override int read() 
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (!IsClrObject)
				return @__env.CallIntMethod(this.JvmHandle, global::java.security.DigestInputStream._read22938);
			else
		...
		public override int read(byte[] arg0, int arg1, int arg2) 
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (!IsClrObject)
				return @__env.CallIntMethod(this.JvmHandle, global::java.security.DigestInputStream._read22939, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0), global::MonoJavaBridge.JavaBridge.ConvertToValue(arg1), global::MonoJavaBridge.JavaBridge.ConvertToValue(arg2));
			else
		...
		public virtual void on(bool arg0) 
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (!IsClrObject)
				@__env.CallVoidMethod(this.JvmHandle, global::java.security.DigestInputStream._on22940, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0));
			else
				@__env.CallNonVirtualVoidMethod(this.JvmHandle, global::java.security.DigestInputStream.staticClass, global::java.security.DigestInputStream._on22940, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0));
		}
		...
		public virtual global::java.security.MessageDigest getMessageDigest() 
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallObjectMethod(this.JvmHandle, global::java.security.DigestInputStream._getMessageDigest22941)) as java.security.MessageDigest;
			else
		...
		public virtual void setMessageDigest(java.security.MessageDigest arg0) 
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (!IsClrObject)
				@__env.CallVoidMethod(this.JvmHandle, global::java.security.DigestInputStream._setMessageDigest22942, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0));
			else
		...
		private static void InitJNI()
		{
			...
			global::java.security.DigestInputStream._toString22937 = @__env.GetMethodIDNoThrow(global::java.security.DigestInputStream.staticClass, "toString", "()Ljava/lang/String;");
			global::java.security.DigestInputStream._read22938 = @__env.GetMethodIDNoThrow(global::java.security.DigestInputStream.staticClass, "read", "()I");
			global::java.security.DigestInputStream._read22939 = @__env.GetMethodIDNoThrow(global::java.security.DigestInputStream.staticClass, "read", "([BII)I");
			global::java.security.DigestInputStream._on22940 = @__env.GetMethodIDNoThrow(global::java.security.DigestInputStream.staticClass, "on", "(Z)V");
			global::java.security.DigestInputStream._getMessageDigest22941 = @__env.GetMethodIDNoThrow(global::java.security.DigestInputStream.staticClass, "getMessageDigest", "()Ljava/security/MessageDigest;");
			global::java.security.DigestInputStream._setMessageDigest22942 = @__env.GetMethodIDNoThrow(global::java.security.DigestInputStream.staticClass, "setMessageDigest", "(Ljava/security/MessageDigest;)V");
			global::java.security.DigestInputStream._DigestInputStream22943 = @__env.GetMethodIDNoThrow(global::java.security.DigestInputStream.staticClass, "<init>", "(Ljava/io/InputStream;Ljava/security/MessageDigest;)V");
		}
	}
}
