namespace java.security
{
	...
	internal sealed partial class Guard_ : java.lang.Object, Guard
	{
		 ...
		 void java.security.Guard.checkGuard(java.lang.Object arg0) 
		{
			...
			if (!IsClrObject)
				@__env.CallVoidMethod(this.JvmHandle, global::java.security.Guard_._checkGuard22956, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0));
			else
				@__env.CallNonVirtualVoidMethod(this.JvmHandle, global::java.security.Guard_.staticClass, global::java.security.Guard_._checkGuard22956, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0));
		}
		private static void InitJNI()
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			global::java.security.Guard_.staticClass = @__env.NewGlobalRef(@__env.FindClass("java/security/Guard"));
			global::java.security.Guard_._checkGuard22956 = @__env.GetMethodIDNoThrow(global::java.security.Guard_.staticClass, "checkGuard", "(Ljava/lang/Object;)V");
		}
	}
}
