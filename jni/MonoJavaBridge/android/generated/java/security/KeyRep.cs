namespace java.security
{
	...
	public partial class KeyRep : java.lang.Object, java.io.Serializable
	{
		...
		public sealed partial class Type : java.lang.Enum
		{
			...
			internal static global::MonoJavaBridge.FieldId _SECRET23059;
			public static global::java.security.KeyRep.Type SECRET
			{
				get
				{
					global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
					return global::MonoJavaBridge.JavaBridge.WrapJavaObjectSealedClass<java.security.KeyRep.Type>(@__env.GetStaticObjectField(global::java.security.KeyRep.Type.staticClass, _SECRET23059)) as java.security.KeyRep.Type;
				}
			}
			internal static global::MonoJavaBridge.FieldId _PUBLIC23060;
			public static global::java.security.KeyRep.Type PUBLIC
			{
				get
				{
					global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
					return global::MonoJavaBridge.JavaBridge.WrapJavaObjectSealedClass<java.security.KeyRep.Type>(@__env.GetStaticObjectField(global::java.security.KeyRep.Type.staticClass, _PUBLIC23060)) as java.security.KeyRep.Type;
				}
			}
			internal static global::MonoJavaBridge.FieldId _PRIVATE23061;
			public static global::java.security.KeyRep.Type PRIVATE
			{
				get
				{
					global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
					return global::MonoJavaBridge.JavaBridge.WrapJavaObjectSealedClass<java.security.KeyRep.Type>(@__env.GetStaticObjectField(global::java.security.KeyRep.Type.staticClass, _PRIVATE23061)) as java.security.KeyRep.Type;
				}
			}
			private static void InitJNI()
			{
				...
				global::java.security.KeyRep.Type._values23057 = @__env.GetStaticMethodIDNoThrow(global::java.security.KeyRep.Type.staticClass, "values", "()[Ljava/security/KeyRep/Type;");
				global::java.security.KeyRep.Type._valueOf23058 = @__env.GetStaticMethodIDNoThrow(global::java.security.KeyRep.Type.staticClass, "valueOf", "(Ljava/lang/String;)Ljava/security/KeyRep$Type;");
				global::java.security.KeyRep.Type._SECRET23059 = @__env.GetStaticFieldIDNoThrow(global::java.security.KeyRep.Type.staticClass, "SECRET", "Ljava/security/KeyRep$Type;");
				global::java.security.KeyRep.Type._PUBLIC23060 = @__env.GetStaticFieldIDNoThrow(global::java.security.KeyRep.Type.staticClass, "PUBLIC", "Ljava/security/KeyRep$Type;");
				global::java.security.KeyRep.Type._PRIVATE23061 = @__env.GetStaticFieldIDNoThrow(global::java.security.KeyRep.Type.staticClass, "PRIVATE", "Ljava/security/KeyRep$Type;");
			}
		}
		...
		protected virtual global::java.lang.Object readResolve()
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallObjectMethod(this.JvmHandle, global::java.security.KeyRep._readResolve23062)) as java.lang.Object;
			else
		...
		private static void InitJNI()
		{
			...
			global::java.security.KeyRep._readResolve23062 = @__env.GetMethodIDNoThrow(global::java.security.KeyRep.staticClass, "readResolve", "()Ljava/lang/Object;");
			global::java.security.KeyRep._KeyRep23063 = @__env.GetMethodIDNoThrow(global::java.security.KeyRep.staticClass, "<init>", "(Ljava/security/KeyRep$Type;Ljava/lang/String;Ljava/lang/String;[B)V");
		}
	}
}
