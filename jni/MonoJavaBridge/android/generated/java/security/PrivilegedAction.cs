namespace java.security
{
	...
	internal sealed partial class PrivilegedAction_ : java.lang.Object, PrivilegedAction
	{
		...
		global::java.lang.Object java.security.PrivilegedAction.run()
		{
			...
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallObjectMethod(this.JvmHandle, global::java.security.PrivilegedAction_._run23246)) as java.lang.Object;
			else
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::java.security.PrivilegedAction_.staticClass, global::java.security.PrivilegedAction_._run23246)) as java.lang.Object;
		}
		private static void InitJNI()
		{
			...
			global::java.security.PrivilegedAction_._run23246 = @__env.GetMethodIDNoThrow(global::java.security.PrivilegedAction_.staticClass, "run", "()Ljava/lang/Object;");
		}
	}
}
