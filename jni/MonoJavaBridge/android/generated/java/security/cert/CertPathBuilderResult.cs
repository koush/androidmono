namespace java.security.cert
{
	...
	internal sealed partial class CertPathBuilderResult_ : java.lang.Object, CertPathBuilderResult
	{
		 ...
		 global::java.lang.Object java.security.cert.CertPathBuilderResult.clone() 
		{
			...
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallObjectMethod(this.JvmHandle, global::java.security.cert.CertPathBuilderResult_._clone23506)) as java.lang.Object;
			else
		 ...
		 global::java.security.cert.CertPath java.security.cert.CertPathBuilderResult.getCertPath() 
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallObjectMethod(this.JvmHandle, global::java.security.cert.CertPathBuilderResult_._getCertPath23507)) as java.security.cert.CertPath;
			else
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::java.security.cert.CertPathBuilderResult_.staticClass, global::java.security.cert.CertPathBuilderResult_._getCertPath23507)) as java.security.cert.CertPath;
		}
		private static void InitJNI()
		{
			...
			global::java.security.cert.CertPathBuilderResult_._clone23506 = @__env.GetMethodIDNoThrow(global::java.security.cert.CertPathBuilderResult_.staticClass, "clone", "()Ljava/lang/Object;");
			global::java.security.cert.CertPathBuilderResult_._getCertPath23507 = @__env.GetMethodIDNoThrow(global::java.security.cert.CertPathBuilderResult_.staticClass, "getCertPath", "()Ljava/security/cert/CertPath;");
		}
	}
}
