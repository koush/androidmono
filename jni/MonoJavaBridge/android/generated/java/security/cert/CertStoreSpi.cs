namespace java.security.cert
{
	...
	public abstract partial class CertStoreSpi : java.lang.Object
	{
		...
		internal static global::MonoJavaBridge.MethodId _engineGetCertificates23548;
		...
		private static void InitJNI()
		{
			...
			global::java.security.cert.CertStoreSpi._engineGetCertificates23548 = @__env.GetMethodIDNoThrow(global::java.security.cert.CertStoreSpi.staticClass, "engineGetCertificates", "(Ljava/security/cert/CertSelector;)Ljava/util/Collection;");
			global::java.security.cert.CertStoreSpi._engineGetCRLs23549 = @__env.GetMethodIDNoThrow(global::java.security.cert.CertStoreSpi.staticClass, "engineGetCRLs", "(Ljava/security/cert/CRLSelector;)Ljava/util/Collection;");
			global::java.security.cert.CertStoreSpi._CertStoreSpi23550 = @__env.GetMethodIDNoThrow(global::java.security.cert.CertStoreSpi.staticClass, "<init>", "(Ljava/security/cert/CertStoreParameters;)V");
		}
	}
	...
	internal sealed partial class CertStoreSpi_ : java.security.cert.CertStoreSpi
	{
		...
		public override global::java.util.Collection engineGetCertificates(java.security.cert.CertSelector arg0)
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapIJavaObject<global::java.util.Collection>(@__env.CallObjectMethod(this.JvmHandle, global::java.security.cert.CertStoreSpi_._engineGetCertificates23551, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0))) as java.util.Collection;
			else
		...
		public override global::java.util.Collection engineGetCRLs(java.security.cert.CRLSelector arg0)
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapIJavaObject<global::java.util.Collection>(@__env.CallObjectMethod(this.JvmHandle, global::java.security.cert.CertStoreSpi_._engineGetCRLs23552, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0))) as java.util.Collection;
			else
		...
		private static void InitJNI()
		{
			...
			global::java.security.cert.CertStoreSpi_._engineGetCertificates23551 = @__env.GetMethodIDNoThrow(global::java.security.cert.CertStoreSpi_.staticClass, "engineGetCertificates", "(Ljava/security/cert/CertSelector;)Ljava/util/Collection;");
			global::java.security.cert.CertStoreSpi_._engineGetCRLs23552 = @__env.GetMethodIDNoThrow(global::java.security.cert.CertStoreSpi_.staticClass, "engineGetCRLs", "(Ljava/security/cert/CRLSelector;)Ljava/util/Collection;");
		}
	}
}
