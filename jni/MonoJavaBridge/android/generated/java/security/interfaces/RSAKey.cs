namespace java.security.interfaces
{
	...
	internal sealed partial class RSAKey_ : java.lang.Object, RSAKey
	{
		...
		global::java.math.BigInteger java.security.interfaces.RSAKey.getModulus()
		{
			...
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallObjectMethod(this.JvmHandle, global::java.security.interfaces.RSAKey_._getModulus23925)) as java.math.BigInteger;
			else
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::java.security.interfaces.RSAKey_.staticClass, global::java.security.interfaces.RSAKey_._getModulus23925)) as java.math.BigInteger;
		}
		private static void InitJNI()
		{
			...
			global::java.security.interfaces.RSAKey_._getModulus23925 = @__env.GetMethodIDNoThrow(global::java.security.interfaces.RSAKey_.staticClass, "getModulus", "()Ljava/math/BigInteger;");
		}
	}
}
