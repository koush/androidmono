namespace java.sql
{
	...
	internal sealed partial class Driver_ : java.lang.Object, Driver
	{
		 ...
		 global::java.sql.Connection java.sql.Driver.connect(java.lang.String arg0, java.util.Properties arg1) 
		{
			...
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapIJavaObject<global::java.sql.Connection>(@__env.CallObjectMethod(this.JvmHandle, global::java.sql.Driver_._connect24619, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0), global::MonoJavaBridge.JavaBridge.ConvertToValue(arg1))) as java.sql.Connection;
			else
		 ...
		 bool java.sql.Driver.acceptsURL(java.lang.String arg0) 
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (!IsClrObject)
				return @__env.CallBooleanMethod(this.JvmHandle, global::java.sql.Driver_._acceptsURL24620, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0));
			else
		 ...
		 int java.sql.Driver.getMajorVersion() 
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (!IsClrObject)
				return @__env.CallIntMethod(this.JvmHandle, global::java.sql.Driver_._getMajorVersion24622);
			else
		 ...
		 int java.sql.Driver.getMinorVersion() 
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (!IsClrObject)
				return @__env.CallIntMethod(this.JvmHandle, global::java.sql.Driver_._getMinorVersion24623);
			else
		 ...
		 bool java.sql.Driver.jdbcCompliant() 
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (!IsClrObject)
				return @__env.CallBooleanMethod(this.JvmHandle, global::java.sql.Driver_._jdbcCompliant24624);
			else
				return @__env.CallNonVirtualBooleanMethod(this.JvmHandle, global::java.sql.Driver_.staticClass, global::java.sql.Driver_._jdbcCompliant24624);
		}
		private static void InitJNI()
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			global::java.sql.Driver_.staticClass = @__env.NewGlobalRef(@__env.FindClass("java/sql/Driver"));
			global::java.sql.Driver_._connect24619 = @__env.GetMethodIDNoThrow(global::java.sql.Driver_.staticClass, "connect", "(Ljava/lang/String;Ljava/util/Properties;)Ljava/sql/Connection;");
			global::java.sql.Driver_._acceptsURL24620 = @__env.GetMethodIDNoThrow(global::java.sql.Driver_.staticClass, "acceptsURL", "(Ljava/lang/String;)Z");
			global::java.sql.Driver_._getPropertyInfo24621 = @__env.GetMethodIDNoThrow(global::java.sql.Driver_.staticClass, "getPropertyInfo", "(Ljava/lang/String;Ljava/util/Properties;)[Ljava/sql/DriverPropertyInfo;");
			global::java.sql.Driver_._getMajorVersion24622 = @__env.GetMethodIDNoThrow(global::java.sql.Driver_.staticClass, "getMajorVersion", "()I");
			global::java.sql.Driver_._getMinorVersion24623 = @__env.GetMethodIDNoThrow(global::java.sql.Driver_.staticClass, "getMinorVersion", "()I");
			global::java.sql.Driver_._jdbcCompliant24624 = @__env.GetMethodIDNoThrow(global::java.sql.Driver_.staticClass, "jdbcCompliant", "()Z");
		}
	}
}
