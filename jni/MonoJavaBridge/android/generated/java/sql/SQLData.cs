namespace java.sql
{
	...
	public sealed partial class SQLData_ : java.lang.Object, SQLData
	{
		 ...
		 global::java.lang.String java.sql.SQLData.getSQLTypeName() 
		{
			...
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapJavaObjectSealedClass<java.lang.String>(@__env.CallObjectMethod(this.JvmHandle, global::java.sql.SQLData_._getSQLTypeName24848)) as java.lang.String;
			else
				return global::MonoJavaBridge.JavaBridge.WrapJavaObjectSealedClass<java.lang.String>(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::java.sql.SQLData_.staticClass, global::java.sql.SQLData_._getSQLTypeName24848)) as java.lang.String;
		}
