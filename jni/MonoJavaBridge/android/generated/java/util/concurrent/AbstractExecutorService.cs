namespace java.util.concurrent
{
	...
	public abstract partial class AbstractExecutorService : java.lang.Object, ExecutorService
	{
		...
		public virtual global::java.util.concurrent.Future submit(java.lang.Runnable arg0, java.lang.Object arg1)
		{
			...
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapIJavaObject<global::java.util.concurrent.Future>(@__env.CallObjectMethod(this.JvmHandle, global::java.util.concurrent.AbstractExecutorService._submit27031, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0), global::MonoJavaBridge.JavaBridge.ConvertToValue(arg1))) as java.util.concurrent.Future;
			else
		...
		public virtual global::java.util.concurrent.Future submit(java.lang.Runnable arg0)
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapIJavaObject<global::java.util.concurrent.Future>(@__env.CallObjectMethod(this.JvmHandle, global::java.util.concurrent.AbstractExecutorService._submit27033, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0))) as java.util.concurrent.Future;
			else
		...
		public virtual global::java.lang.Object invokeAny(java.util.Collection arg0)
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallObjectMethod(this.JvmHandle, global::java.util.concurrent.AbstractExecutorService._invokeAny27034, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0))) as java.lang.Object;
			else
		...
		public virtual global::java.util.List invokeAll(java.util.Collection arg0)
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapIJavaObject<global::java.util.List>(@__env.CallObjectMethod(this.JvmHandle, global::java.util.concurrent.AbstractExecutorService._invokeAll27036, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0))) as java.util.List;
			else
	...
	internal sealed partial class AbstractExecutorService_ : java.util.concurrent.AbstractExecutorService
	{
		...
		public override void shutdown()
		{
			...
			if (!IsClrObject)
				...
				@__env.CallNonVirtualVoidMethod(this.JvmHandle, global::java.util.concurrent.AbstractExecutorService_.staticClass, global::java.util.concurrent.AbstractExecutorService_._shutdown27039);
		}
		...
		public override bool awaitTermination(long arg0, java.util.concurrent.TimeUnit arg1)
		{
			...
			if (!IsClrObject)
				...
				return @__env.CallNonVirtualBooleanMethod(this.JvmHandle, global::java.util.concurrent.AbstractExecutorService_.staticClass, global::java.util.concurrent.AbstractExecutorService_._awaitTermination27040, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0), global::MonoJavaBridge.JavaBridge.ConvertToValue(arg1));
		}
		...
		public override global::java.util.List shutdownNow()
		{
			...
			if (!IsClrObject)
				...
				return global::MonoJavaBridge.JavaBridge.WrapIJavaObject<global::java.util.List>(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::java.util.concurrent.AbstractExecutorService_.staticClass, global::java.util.concurrent.AbstractExecutorService_._shutdownNow27041)) as java.util.List;
		}
		...
		public override bool isShutdown()
		{
			...
			if (!IsClrObject)
				...
				return @__env.CallNonVirtualBooleanMethod(this.JvmHandle, global::java.util.concurrent.AbstractExecutorService_.staticClass, global::java.util.concurrent.AbstractExecutorService_._isShutdown27042);
		}
		...
		public override bool isTerminated()
		{
			...
			if (!IsClrObject)
				...
				return @__env.CallNonVirtualBooleanMethod(this.JvmHandle, global::java.util.concurrent.AbstractExecutorService_.staticClass, global::java.util.concurrent.AbstractExecutorService_._isTerminated27043);
		}
		...
		public override void execute(java.lang.Runnable arg0)
		{
			...
			if (!IsClrObject)
				...
				@__env.CallNonVirtualVoidMethod(this.JvmHandle, global::java.util.concurrent.AbstractExecutorService_.staticClass, global::java.util.concurrent.AbstractExecutorService_._execute27044, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0));
		}
