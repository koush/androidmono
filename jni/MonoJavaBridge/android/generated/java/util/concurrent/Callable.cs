namespace java.util.concurrent
{
	...
	internal sealed partial class Callable_ : java.lang.Object, Callable
	{
		 ...
		 global::java.lang.Object java.util.concurrent.Callable.call() 
		{
			...
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallObjectMethod(this.JvmHandle, global::java.util.concurrent.Callable_._call27101)) as java.lang.Object;
			else
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::java.util.concurrent.Callable_.staticClass, global::java.util.concurrent.Callable_._call27101)) as java.lang.Object;
		}
		private static void InitJNI()
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			global::java.util.concurrent.Callable_.staticClass = @__env.NewGlobalRef(@__env.FindClass("java/util/concurrent/Callable"));
			global::java.util.concurrent.Callable_._call27101 = @__env.GetMethodIDNoThrow(global::java.util.concurrent.Callable_.staticClass, "call", "()Ljava/lang/Object;");
		}
	}
}
