namespace java.util.concurrent
{
	...
	public sealed partial class Executor_ : java.lang.Object, Executor
	{
		...
		internal static global::MonoJavaBridge.MethodId _execute27142;
		 void java.util.concurrent.Executor.execute(java.lang.Runnable arg0) 
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (!IsClrObject)
				@__env.CallVoidMethod(this.JvmHandle, global::java.util.concurrent.Executor_._execute27142, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0));
			else
				@__env.CallNonVirtualVoidMethod(this.JvmHandle, global::java.util.concurrent.Executor_.staticClass, global::java.util.concurrent.Executor_._execute27142, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0));
		}
		private static void InitJNI()
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			global::java.util.concurrent.Executor_.staticClass = @__env.NewGlobalRef(@__env.FindClass("java/util/concurrent/Executor"));
			global::java.util.concurrent.Executor_._execute27142 = @__env.GetMethodIDNoThrow(global::java.util.concurrent.Executor_.staticClass, "execute", "(Ljava/lang/Runnable;)V");
		}
	}
}
