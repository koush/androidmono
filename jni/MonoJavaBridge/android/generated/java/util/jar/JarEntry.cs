namespace java.util.jar
{
	...
	public partial class JarEntry : java.util.zip.ZipEntry
	{
		...
		public virtual global::java.security.cert.Certificate[] getCertificates() 
		{
			...
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapJavaArrayObject<java.security.cert.Certificate>(@__env.CallObjectMethod(this.JvmHandle, global::java.util.jar.JarEntry._getCertificates27856)) as java.security.cert.Certificate[];
			else
				return global::MonoJavaBridge.JavaBridge.WrapJavaArrayObject<java.security.cert.Certificate>(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::java.util.jar.JarEntry.staticClass, global::java.util.jar.JarEntry._getCertificates27856)) as java.security.cert.Certificate[];
		}
		...
		public virtual global::java.security.CodeSigner[] getCodeSigners() 
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapJavaArrayObject<java.security.CodeSigner>(@__env.CallObjectMethod(this.JvmHandle, global::java.util.jar.JarEntry._getCodeSigners27857)) as java.security.CodeSigner[];
			else
				return global::MonoJavaBridge.JavaBridge.WrapJavaArrayObject<java.security.CodeSigner>(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::java.util.jar.JarEntry.staticClass, global::java.util.jar.JarEntry._getCodeSigners27857)) as java.security.CodeSigner[];
		}
		...
		public virtual global::java.util.jar.Attributes getAttributes() 
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallObjectMethod(this.JvmHandle, global::java.util.jar.JarEntry._getAttributes27858)) as java.util.jar.Attributes;
			else
		...
		private static void InitJNI()
		{
			...
			global::java.util.jar.JarEntry._getCertificates27856 = @__env.GetMethodIDNoThrow(global::java.util.jar.JarEntry.staticClass, "getCertificates", "()[Ljava/security/cert/Certificate;");
			global::java.util.jar.JarEntry._getCodeSigners27857 = @__env.GetMethodIDNoThrow(global::java.util.jar.JarEntry.staticClass, "getCodeSigners", "()[Ljava/security/CodeSigner;");
			global::java.util.jar.JarEntry._getAttributes27858 = @__env.GetMethodIDNoThrow(global::java.util.jar.JarEntry.staticClass, "getAttributes", "()Ljava/util/jar/Attributes;");
			global::java.util.jar.JarEntry._JarEntry27859 = @__env.GetMethodIDNoThrow(global::java.util.jar.JarEntry.staticClass, "<init>", "(Ljava/lang/String;)V");
			global::java.util.jar.JarEntry._JarEntry27860 = @__env.GetMethodIDNoThrow(global::java.util.jar.JarEntry.staticClass, "<init>", "(Ljava/util/zip/ZipEntry;)V");
			global::java.util.jar.JarEntry._JarEntry27861 = @__env.GetMethodIDNoThrow(global::java.util.jar.JarEntry.staticClass, "<init>", "(Ljava/util/jar/JarEntry;)V");
		}
	}
}
