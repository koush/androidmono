namespace java.util.prefs
{
	...
	public partial class NodeChangeEvent : java.util.EventObject
	{
		...
		public virtual global::java.util.prefs.Preferences getParent()
		{
			...
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallObjectMethod(this.JvmHandle, global::java.util.prefs.NodeChangeEvent._getParent28176)) as java.util.prefs.Preferences;
			else
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::java.util.prefs.NodeChangeEvent.staticClass, global::java.util.prefs.NodeChangeEvent._getParent28176)) as java.util.prefs.Preferences;
		}
		...
		public virtual global::java.util.prefs.Preferences getChild()
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallObjectMethod(this.JvmHandle, global::java.util.prefs.NodeChangeEvent._getChild28177)) as java.util.prefs.Preferences;
			else
		...
		private static void InitJNI()
		{
			...
			global::java.util.prefs.NodeChangeEvent._getParent28176 = @__env.GetMethodIDNoThrow(global::java.util.prefs.NodeChangeEvent.staticClass, "getParent", "()Ljava/util/prefs/Preferences;");
			global::java.util.prefs.NodeChangeEvent._getChild28177 = @__env.GetMethodIDNoThrow(global::java.util.prefs.NodeChangeEvent.staticClass, "getChild", "()Ljava/util/prefs/Preferences;");
			global::java.util.prefs.NodeChangeEvent._NodeChangeEvent28178 = @__env.GetMethodIDNoThrow(global::java.util.prefs.NodeChangeEvent.staticClass, "<init>", "(Ljava/util/prefs/Preferences;Ljava/util/prefs/Preferences;)V");
		}
	}
}
