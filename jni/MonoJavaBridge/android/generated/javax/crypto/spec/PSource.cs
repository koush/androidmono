	...
	public partial class PSource : java.lang.Object
	{
		...
		public sealed partial class PSpecified : javax.crypto.spec.PSource
		{
			...
			public byte[] getValue() 
			{
				...
				if (!IsClrObject)
					return global::MonoJavaBridge.JavaBridge.WrapJavaArrayObject<byte>(@__env.CallObjectMethod(this.JvmHandle, global::javax.crypto.spec.PSource.PSpecified._getValue28802)) as byte[];
				else
			...
			internal static global::MonoJavaBridge.FieldId _DEFAULT28804;
			public static global::javax.crypto.spec.PSource.PSpecified DEFAULT
			{
				get
				{
					global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
					return global::MonoJavaBridge.JavaBridge.WrapJavaObjectSealedClass<javax.crypto.spec.PSource.PSpecified>(@__env.GetStaticObjectField(global::javax.crypto.spec.PSource.PSpecified.staticClass, _DEFAULT28804)) as javax.crypto.spec.PSource.PSpecified;
				}
			}
			private static void InitJNI()
			{
				...
				global::javax.crypto.spec.PSource.PSpecified._getValue28802 = @__env.GetMethodIDNoThrow(global::javax.crypto.spec.PSource.PSpecified.staticClass, "getValue", "()[B");
				global::javax.crypto.spec.PSource.PSpecified._PSpecified28803 = @__env.GetMethodIDNoThrow(global::javax.crypto.spec.PSource.PSpecified.staticClass, "<init>", "([B)V");
				global::javax.crypto.spec.PSource.PSpecified._DEFAULT28804 = @__env.GetStaticFieldIDNoThrow(global::javax.crypto.spec.PSource.PSpecified.staticClass, "DEFAULT", "Ljavax/crypto/spec/PSource$PSpecified;");
			}
		}
		...
		public virtual global::java.lang.String getAlgorithm() 
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapJavaObjectSealedClass<java.lang.String>(@__env.CallObjectMethod(this.JvmHandle, global::javax.crypto.spec.PSource._getAlgorithm28805)) as java.lang.String;
			else
		...
		private static void InitJNI()
		{
			...
			global::javax.crypto.spec.PSource._getAlgorithm28805 = @__env.GetMethodIDNoThrow(global::javax.crypto.spec.PSource.staticClass, "getAlgorithm", "()Ljava/lang/String;");
			global::javax.crypto.spec.PSource._PSource28806 = @__env.GetMethodIDNoThrow(global::javax.crypto.spec.PSource.staticClass, "<init>", "(Ljava/lang/String;)V");
		}
	}
}
