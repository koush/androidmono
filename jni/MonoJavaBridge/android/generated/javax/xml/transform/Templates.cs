namespace javax.xml.transform
{
	...
	internal sealed partial class Templates_ : java.lang.Object, Templates
	{
		...
		global::javax.xml.transform.Transformer javax.xml.transform.Templates.newTransformer()
		{
			...
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallObjectMethod(this.JvmHandle, global::javax.xml.transform.Templates_._newTransformer30956)) as javax.xml.transform.Transformer;
			else
		...
		global::java.util.Properties javax.xml.transform.Templates.getOutputProperties()
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallObjectMethod(this.JvmHandle, global::javax.xml.transform.Templates_._getOutputProperties30957)) as java.util.Properties;
			else
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::javax.xml.transform.Templates_.staticClass, global::javax.xml.transform.Templates_._getOutputProperties30957)) as java.util.Properties;
		}
		private static void InitJNI()
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			global::javax.xml.transform.Templates_.staticClass = @__env.NewGlobalRef(@__env.FindClass("javax/xml/transform/Templates"));
			global::javax.xml.transform.Templates_._newTransformer30956 = @__env.GetMethodIDNoThrow(global::javax.xml.transform.Templates_.staticClass, "newTransformer", "()Ljavax/xml/transform/Transformer;");
			global::javax.xml.transform.Templates_._getOutputProperties30957 = @__env.GetMethodIDNoThrow(global::javax.xml.transform.Templates_.staticClass, "getOutputProperties", "()Ljava/util/Properties;");
		}
	}
}
