	...
	internal sealed partial class DOMLocator_ : java.lang.Object, DOMLocator
	{
		...
		global::org.w3c.dom.Node javax.xml.transform.dom.DOMLocator.getOriginatingNode()
		{
			...
			if (!IsClrObject)
				...
				return global::MonoJavaBridge.JavaBridge.WrapIJavaObject<global::org.w3c.dom.Node>(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::javax.xml.transform.dom.DOMLocator_.staticClass, global::javax.xml.transform.dom.DOMLocator_._getOriginatingNode31040)) as org.w3c.dom.Node;
		}
		...
		int javax.xml.transform.SourceLocator.getLineNumber()
		{
			...
			if (!IsClrObject)
				...
				return @__env.CallNonVirtualIntMethod(this.JvmHandle, global::javax.xml.transform.dom.DOMLocator_.staticClass, global::javax.xml.transform.dom.DOMLocator_._getLineNumber31041);
		}
		...
		global::java.lang.String javax.xml.transform.SourceLocator.getPublicId()
		{
			...
			if (!IsClrObject)
				...
				return global::MonoJavaBridge.JavaBridge.WrapJavaObjectSealedClass<java.lang.String>(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::javax.xml.transform.dom.DOMLocator_.staticClass, global::javax.xml.transform.dom.DOMLocator_._getPublicId31042)) as java.lang.String;
		}
		...
		global::java.lang.String javax.xml.transform.SourceLocator.getSystemId()
		{
			...
			if (!IsClrObject)
				...
				return global::MonoJavaBridge.JavaBridge.WrapJavaObjectSealedClass<java.lang.String>(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::javax.xml.transform.dom.DOMLocator_.staticClass, global::javax.xml.transform.dom.DOMLocator_._getSystemId31043)) as java.lang.String;
		}
