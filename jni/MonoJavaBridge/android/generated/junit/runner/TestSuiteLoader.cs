	...
	internal sealed partial class TestSuiteLoader_ : java.lang.Object, TestSuiteLoader
	{
		...
		global::java.lang.Class junit.runner.TestSuiteLoader.load(java.lang.String arg0)
		{
			...
			if (!IsClrObject)
				...
				return global::MonoJavaBridge.JavaBridge.WrapJavaObjectSealedClass<java.lang.Class>(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::junit.runner.TestSuiteLoader_.staticClass, global::junit.runner.TestSuiteLoader_._load31469, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0))) as java.lang.Class;
		}
