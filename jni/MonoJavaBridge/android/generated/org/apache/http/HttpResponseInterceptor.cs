namespace org.apache.http
{
	...
	public sealed partial class HttpResponseInterceptor_ : java.lang.Object, HttpResponseInterceptor
	{
		...
		internal static global::MonoJavaBridge.MethodId _process25058;
		 void org.apache.http.HttpResponseInterceptor.process(org.apache.http.HttpResponse arg0, org.apache.http.protocol.HttpContext arg1) 
		{
			...
			if (!IsClrObject)
				@__env.CallVoidMethod(this.JvmHandle, global::org.apache.http.HttpResponseInterceptor_._process25058, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0), global::MonoJavaBridge.JavaBridge.ConvertToValue(arg1));
			else
				@__env.CallNonVirtualVoidMethod(this.JvmHandle, global::org.apache.http.HttpResponseInterceptor_.staticClass, global::org.apache.http.HttpResponseInterceptor_._process25058, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0), global::MonoJavaBridge.JavaBridge.ConvertToValue(arg1));
		}
		private static void InitJNI()
		{
			...
			global::org.apache.http.HttpResponseInterceptor_._process25058 = @__env.GetMethodIDNoThrow(global::org.apache.http.HttpResponseInterceptor_.staticClass, "process", "(Lorg/apache/http/HttpResponse;Lorg/apache/http/protocol/HttpContext;)V");
		}
	}
}
