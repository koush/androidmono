namespace org.apache.http.auth
{
	...
	internal sealed partial class AuthSchemeFactory_ : java.lang.Object, AuthSchemeFactory
	{
		...
		global::org.apache.http.auth.AuthScheme org.apache.http.auth.AuthSchemeFactory.newInstance(org.apache.http.@params.HttpParams arg0)
		{
			...
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapIJavaObject<global::org.apache.http.auth.AuthScheme>(@__env.CallObjectMethod(this.JvmHandle, global::org.apache.http.auth.AuthSchemeFactory_._newInstance31783, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0))) as org.apache.http.auth.AuthScheme;
			else
				return global::MonoJavaBridge.JavaBridge.WrapIJavaObject<global::org.apache.http.auth.AuthScheme>(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::org.apache.http.auth.AuthSchemeFactory_.staticClass, global::org.apache.http.auth.AuthSchemeFactory_._newInstance31783, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0))) as org.apache.http.auth.AuthScheme;
		}
		private static void InitJNI()
		{
			...
			global::org.apache.http.auth.AuthSchemeFactory_._newInstance31783 = @__env.GetMethodIDNoThrow(global::org.apache.http.auth.AuthSchemeFactory_.staticClass, "newInstance", "(Lorg/apache/http/params/HttpParams;)Lorg/apache/http/auth/AuthScheme;");
		}
	}
}
