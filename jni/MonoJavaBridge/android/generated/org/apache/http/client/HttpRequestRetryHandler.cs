namespace org.apache.http.client
{
	...
	public sealed partial class HttpRequestRetryHandler_ : java.lang.Object, HttpRequestRetryHandler
	{
		...
		internal static global::MonoJavaBridge.MethodId _retryRequest31772;
		 bool org.apache.http.client.HttpRequestRetryHandler.retryRequest(java.io.IOException arg0, int arg1, org.apache.http.protocol.HttpContext arg2) 
		{
			...
			if (!IsClrObject)
				return @__env.CallBooleanMethod(this.JvmHandle, global::org.apache.http.client.HttpRequestRetryHandler_._retryRequest31772, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0), global::MonoJavaBridge.JavaBridge.ConvertToValue(arg1), global::MonoJavaBridge.JavaBridge.ConvertToValue(arg2));
			else
				return @__env.CallNonVirtualBooleanMethod(this.JvmHandle, global::org.apache.http.client.HttpRequestRetryHandler_.staticClass, global::org.apache.http.client.HttpRequestRetryHandler_._retryRequest31772, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0), global::MonoJavaBridge.JavaBridge.ConvertToValue(arg1), global::MonoJavaBridge.JavaBridge.ConvertToValue(arg2));
		}
		private static void InitJNI()
		{
			...
			global::org.apache.http.client.HttpRequestRetryHandler_._retryRequest31772 = @__env.GetMethodIDNoThrow(global::org.apache.http.client.HttpRequestRetryHandler_.staticClass, "retryRequest", "(Ljava/io/IOException;ILorg/apache/http/protocol/HttpContext;)Z");
		}
	}
}
