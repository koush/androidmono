namespace org.apache.http.client.protocol
{
	...
	public partial class ResponseProcessCookies : java.lang.Object, HttpResponseInterceptor
	{
		...
		public virtual void process(org.apache.http.HttpResponse arg0, org.apache.http.protocol.HttpContext arg1)
		{
			...
			if (!IsClrObject)
				@__env.CallVoidMethod(this.JvmHandle, global::org.apache.http.client.protocol.ResponseProcessCookies._process32046, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0), global::MonoJavaBridge.JavaBridge.ConvertToValue(arg1));
			else
