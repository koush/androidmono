namespace org.apache.http.conn
{
	...
	internal sealed partial class ClientConnectionManagerFactory_ : java.lang.Object, ClientConnectionManagerFactory
	{
		...
		internal static global::MonoJavaBridge.MethodId _newInstance32081;
		 global::org.apache.http.conn.ClientConnectionManager org.apache.http.conn.ClientConnectionManagerFactory.newInstance(org.apache.http.@params.HttpParams arg0, org.apache.http.conn.scheme.SchemeRegistry arg1) 
		{
			...
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapIJavaObject<global::org.apache.http.conn.ClientConnectionManager>(@__env.CallObjectMethod(this.JvmHandle, global::org.apache.http.conn.ClientConnectionManagerFactory_._newInstance32081, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0), global::MonoJavaBridge.JavaBridge.ConvertToValue(arg1))) as org.apache.http.conn.ClientConnectionManager;
			else
				return global::MonoJavaBridge.JavaBridge.WrapIJavaObject<global::org.apache.http.conn.ClientConnectionManager>(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::org.apache.http.conn.ClientConnectionManagerFactory_.staticClass, global::org.apache.http.conn.ClientConnectionManagerFactory_._newInstance32081, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0), global::MonoJavaBridge.JavaBridge.ConvertToValue(arg1))) as org.apache.http.conn.ClientConnectionManager;
		}
		private static void InitJNI()
		{
			...
			global::org.apache.http.conn.ClientConnectionManagerFactory_._newInstance32081 = @__env.GetMethodIDNoThrow(global::org.apache.http.conn.ClientConnectionManagerFactory_.staticClass, "newInstance", "(Lorg/apache/http/params/HttpParams;Lorg/apache/http/conn/scheme/SchemeRegistry;)Lorg/apache/http/conn/ClientConnectionManager;");
		}
	}
}
