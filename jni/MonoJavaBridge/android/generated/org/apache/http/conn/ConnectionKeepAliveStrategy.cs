namespace org.apache.http.conn
{
	...
	public sealed partial class ConnectionKeepAliveStrategy_ : java.lang.Object, ConnectionKeepAliveStrategy
	{
		...
		internal static global::MonoJavaBridge.MethodId _getKeepAliveDuration31971;
		 long org.apache.http.conn.ConnectionKeepAliveStrategy.getKeepAliveDuration(org.apache.http.HttpResponse arg0, org.apache.http.protocol.HttpContext arg1) 
		{
			...
			if (!IsClrObject)
				return @__env.CallLongMethod(this.JvmHandle, global::org.apache.http.conn.ConnectionKeepAliveStrategy_._getKeepAliveDuration31971, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0), global::MonoJavaBridge.JavaBridge.ConvertToValue(arg1));
			else
				return @__env.CallNonVirtualLongMethod(this.JvmHandle, global::org.apache.http.conn.ConnectionKeepAliveStrategy_.staticClass, global::org.apache.http.conn.ConnectionKeepAliveStrategy_._getKeepAliveDuration31971, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0), global::MonoJavaBridge.JavaBridge.ConvertToValue(arg1));
		}
		private static void InitJNI()
		{
			...
			global::org.apache.http.conn.ConnectionKeepAliveStrategy_._getKeepAliveDuration31971 = @__env.GetMethodIDNoThrow(global::org.apache.http.conn.ConnectionKeepAliveStrategy_.staticClass, "getKeepAliveDuration", "(Lorg/apache/http/HttpResponse;Lorg/apache/http/protocol/HttpContext;)J");
		}
	}
}
