namespace org.apache.http.conn
{
	...
	public partial class HttpHostConnectException : java.net.ConnectException
	{
		...
		public virtual global::org.apache.http.HttpHost getHost()
		{
			...
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapJavaObjectSealedClass<org.apache.http.HttpHost>(@__env.CallObjectMethod(this.JvmHandle, global::org.apache.http.conn.HttpHostConnectException._getHost32109)) as org.apache.http.HttpHost;
			else
		...
		private static void InitJNI()
		{
			...
			global::org.apache.http.conn.HttpHostConnectException._getHost32109 = @__env.GetMethodIDNoThrow(global::org.apache.http.conn.HttpHostConnectException.staticClass, "getHost", "()Lorg/apache/http/HttpHost;");
			global::org.apache.http.conn.HttpHostConnectException._HttpHostConnectException32110 = @__env.GetMethodIDNoThrow(global::org.apache.http.conn.HttpHostConnectException.staticClass, "<init>", "(Lorg/apache/http/HttpHost;Ljava/net/ConnectException;)V");
		}
	}
}
