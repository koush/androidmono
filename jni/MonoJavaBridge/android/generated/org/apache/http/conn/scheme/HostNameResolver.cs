namespace org.apache.http.conn.scheme
{
	...
	internal sealed partial class HostNameResolver_ : java.lang.Object, HostNameResolver
	{
		 ...
		 global::java.net.InetAddress org.apache.http.conn.scheme.HostNameResolver.resolve(java.lang.String arg0) 
		{
			...
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallObjectMethod(this.JvmHandle, global::org.apache.http.conn.scheme.HostNameResolver_._resolve32288, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0))) as java.net.InetAddress;
			else
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::org.apache.http.conn.scheme.HostNameResolver_.staticClass, global::org.apache.http.conn.scheme.HostNameResolver_._resolve32288, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0))) as java.net.InetAddress;
		}
		private static void InitJNI()
		{
			...
			global::org.apache.http.conn.scheme.HostNameResolver_._resolve32288 = @__env.GetMethodIDNoThrow(global::org.apache.http.conn.scheme.HostNameResolver_.staticClass, "resolve", "(Ljava/lang/String;)Ljava/net/InetAddress;");
		}
	}
}
