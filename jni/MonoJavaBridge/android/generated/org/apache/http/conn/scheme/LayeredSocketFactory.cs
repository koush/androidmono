	...
	internal sealed partial class LayeredSocketFactory_ : java.lang.Object, LayeredSocketFactory
	{
		...
		global::java.net.Socket org.apache.http.conn.scheme.SocketFactory.createSocket()
		{
			...
			if (!IsClrObject)
				...
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::org.apache.http.conn.scheme.LayeredSocketFactory_.staticClass, global::org.apache.http.conn.scheme.LayeredSocketFactory_._createSocket32291)) as java.net.Socket;
		}
		...
		global::java.net.Socket org.apache.http.conn.scheme.SocketFactory.connectSocket(java.net.Socket arg0, java.lang.String arg1, int arg2, java.net.InetAddress arg3, int arg4, org.apache.http.@params.HttpParams arg5)
		{
			...
			if (!IsClrObject)
				...
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::org.apache.http.conn.scheme.LayeredSocketFactory_.staticClass, global::org.apache.http.conn.scheme.LayeredSocketFactory_._connectSocket32292, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0), global::MonoJavaBridge.JavaBridge.ConvertToValue(arg1), global::MonoJavaBridge.JavaBridge.ConvertToValue(arg2), global::MonoJavaBridge.JavaBridge.ConvertToValue(arg3), global::MonoJavaBridge.JavaBridge.ConvertToValue(arg4), global::MonoJavaBridge.JavaBridge.ConvertToValue(arg5))) as java.net.Socket;
		}
		...
		bool org.apache.http.conn.scheme.SocketFactory.isSecure(java.net.Socket arg0)
		{
			...
			if (!IsClrObject)
				...
				return @__env.CallNonVirtualBooleanMethod(this.JvmHandle, global::org.apache.http.conn.scheme.LayeredSocketFactory_.staticClass, global::org.apache.http.conn.scheme.LayeredSocketFactory_._isSecure32293, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0));
		}
