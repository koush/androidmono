namespace org.apache.http.conn.scheme
{
	...
	public sealed partial class SocketFactory_ : java.lang.Object, SocketFactory
	{
		...
		internal static global::MonoJavaBridge.MethodId _createSocket16417;
		 global::java.net.Socket org.apache.http.conn.scheme.SocketFactory.createSocket() 
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallObjectMethod(this.JvmHandle, global::org.apache.http.conn.scheme.SocketFactory_._createSocket16417)) as java.net.Socket;
			else
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::org.apache.http.conn.scheme.SocketFactory_.staticClass, global::org.apache.http.conn.scheme.SocketFactory_._createSocket16417)) as java.net.Socket;
		}
		internal static global::MonoJavaBridge.MethodId _connectSocket16418;
		...
		internal static global::MonoJavaBridge.MethodId _isSecure16419;
		...
		private static void InitJNI()
		{
			...
			global::org.apache.http.conn.scheme.SocketFactory_._createSocket16417 = @__env.GetMethodIDNoThrow(global::org.apache.http.conn.scheme.SocketFactory_.staticClass, "createSocket", "()Ljava/net/Socket;");
			global::org.apache.http.conn.scheme.SocketFactory_._connectSocket16418 = @__env.GetMethodIDNoThrow(global::org.apache.http.conn.scheme.SocketFactory_.staticClass, "connectSocket", "(Ljava/net/Socket;Ljava/lang/String;ILjava/net/InetAddress;ILorg/apache/http/@params/HttpParams;)Ljava/net/Socket;");
			global::org.apache.http.conn.scheme.SocketFactory_._isSecure16419 = @__env.GetMethodIDNoThrow(global::org.apache.http.conn.scheme.SocketFactory_.staticClass, "isSecure", "(Ljava/net/Socket;)Z");
		}
	}
}
