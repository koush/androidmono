namespace org.apache.http.entity
{
	...
	public sealed partial class ContentLengthStrategy_ : java.lang.Object, ContentLengthStrategy
	{
		...
		internal static global::MonoJavaBridge.MethodId _determineLength25793;
		 long org.apache.http.entity.ContentLengthStrategy.determineLength(org.apache.http.HttpMessage arg0) 
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (!IsClrObject)
				return @__env.CallLongMethod(this.JvmHandle, global::org.apache.http.entity.ContentLengthStrategy_._determineLength25793, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0));
			else
				return @__env.CallNonVirtualLongMethod(this.JvmHandle, global::org.apache.http.entity.ContentLengthStrategy_.staticClass, global::org.apache.http.entity.ContentLengthStrategy_._determineLength25793, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0));
		}
		private static void InitJNI()
		{
			...
			global::org.apache.http.entity.ContentLengthStrategy_._determineLength25793 = @__env.GetMethodIDNoThrow(global::org.apache.http.entity.ContentLengthStrategy_.staticClass, "determineLength", "(Lorg/apache/http/HttpMessage;)J");
		}
	}
}
