namespace org.apache.http.impl.auth
{
	...
	public partial class DigestSchemeFactory : java.lang.Object, org.apache.http.auth.AuthSchemeFactory
	{
		...
		public virtual global::org.apache.http.auth.AuthScheme newInstance(org.apache.http.@params.HttpParams arg0)
		{
			...
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapIJavaObject<global::org.apache.http.auth.AuthScheme>(@__env.CallObjectMethod(this.JvmHandle, global::org.apache.http.impl.auth.DigestSchemeFactory._newInstance32735, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0))) as org.apache.http.auth.AuthScheme;
			else
