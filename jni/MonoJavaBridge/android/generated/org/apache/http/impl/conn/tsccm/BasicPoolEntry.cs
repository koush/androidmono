namespace org.apache.http.impl.conn.tsccm
{
	...
	public partial class BasicPoolEntry : org.apache.http.impl.conn.AbstractPoolEntry
	{
		...
		protected virtual global::org.apache.http.conn.OperatedClientConnection getConnection()
		{
			...
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapIJavaObject<global::org.apache.http.conn.OperatedClientConnection>(@__env.CallObjectMethod(this.JvmHandle, global::org.apache.http.impl.conn.tsccm.BasicPoolEntry._getConnection33122)) as org.apache.http.conn.OperatedClientConnection;
			else
		...
		protected virtual global::org.apache.http.conn.routing.HttpRoute getPlannedRoute()
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapJavaObjectSealedClass<org.apache.http.conn.routing.HttpRoute>(@__env.CallObjectMethod(this.JvmHandle, global::org.apache.http.impl.conn.tsccm.BasicPoolEntry._getPlannedRoute33123)) as org.apache.http.conn.routing.HttpRoute;
			else
		...
		protected virtual global::org.apache.http.impl.conn.tsccm.BasicPoolEntryRef getWeakRef()
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallObjectMethod(this.JvmHandle, global::org.apache.http.impl.conn.tsccm.BasicPoolEntry._getWeakRef33124)) as org.apache.http.impl.conn.tsccm.BasicPoolEntryRef;
			else
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::org.apache.http.impl.conn.tsccm.BasicPoolEntry.staticClass, global::org.apache.http.impl.conn.tsccm.BasicPoolEntry._getWeakRef33124)) as org.apache.http.impl.conn.tsccm.BasicPoolEntryRef;
		}
