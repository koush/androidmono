namespace org.apache.http.impl.conn.tsccm
{
	...
	internal sealed partial class PoolEntryRequest_ : java.lang.Object, PoolEntryRequest
	{
		 ...
		 void org.apache.http.impl.conn.tsccm.PoolEntryRequest.abortRequest() 
		{
			...
			if (!IsClrObject)
				@__env.CallVoidMethod(this.JvmHandle, global::org.apache.http.impl.conn.tsccm.PoolEntryRequest_._abortRequest33150);
			else
		 ...
		 global::org.apache.http.impl.conn.tsccm.BasicPoolEntry org.apache.http.impl.conn.tsccm.PoolEntryRequest.getPoolEntry(long arg0, java.util.concurrent.TimeUnit arg1) 
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallObjectMethod(this.JvmHandle, global::org.apache.http.impl.conn.tsccm.PoolEntryRequest_._getPoolEntry33151, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0), global::MonoJavaBridge.JavaBridge.ConvertToValue(arg1))) as org.apache.http.impl.conn.tsccm.BasicPoolEntry;
			else
				return global::MonoJavaBridge.JavaBridge.WrapJavaObject(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::org.apache.http.impl.conn.tsccm.PoolEntryRequest_.staticClass, global::org.apache.http.impl.conn.tsccm.PoolEntryRequest_._getPoolEntry33151, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0), global::MonoJavaBridge.JavaBridge.ConvertToValue(arg1))) as org.apache.http.impl.conn.tsccm.BasicPoolEntry;
		}
		private static void InitJNI()
		{
			...
			global::org.apache.http.impl.conn.tsccm.PoolEntryRequest_._abortRequest33150 = @__env.GetMethodIDNoThrow(global::org.apache.http.impl.conn.tsccm.PoolEntryRequest_.staticClass, "abortRequest", "()V");
			global::org.apache.http.impl.conn.tsccm.PoolEntryRequest_._getPoolEntry33151 = @__env.GetMethodIDNoThrow(global::org.apache.http.impl.conn.tsccm.PoolEntryRequest_.staticClass, "getPoolEntry", "(JLjava/util/concurrent/TimeUnit;)Lorg/apache/http/impl/conn/tsccm/BasicPoolEntry;");
		}
	}
}
