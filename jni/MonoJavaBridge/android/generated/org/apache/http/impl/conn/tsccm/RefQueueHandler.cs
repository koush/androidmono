namespace org.apache.http.impl.conn.tsccm
{
	...
	internal sealed partial class RefQueueHandler_ : java.lang.Object, RefQueueHandler
	{
		 ...
		 void org.apache.http.impl.conn.tsccm.RefQueueHandler.handleReference(java.lang.@ref.Reference arg0) 
		{
			...
			if (!IsClrObject)
				@__env.CallVoidMethod(this.JvmHandle, global::org.apache.http.impl.conn.tsccm.RefQueueHandler_._handleReference33152, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0));
			else
				@__env.CallNonVirtualVoidMethod(this.JvmHandle, global::org.apache.http.impl.conn.tsccm.RefQueueHandler_.staticClass, global::org.apache.http.impl.conn.tsccm.RefQueueHandler_._handleReference33152, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0));
		}
		private static void InitJNI()
		{
			...
			global::org.apache.http.impl.conn.tsccm.RefQueueHandler_._handleReference33152 = @__env.GetMethodIDNoThrow(global::org.apache.http.impl.conn.tsccm.RefQueueHandler_.staticClass, "handleReference", "(Ljava/lang/ref/Reference;)V");
		}
	}
}
