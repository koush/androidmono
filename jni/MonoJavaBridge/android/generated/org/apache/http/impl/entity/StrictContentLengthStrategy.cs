namespace org.apache.http.impl.entity
{
	...
	public partial class StrictContentLengthStrategy : java.lang.Object, org.apache.http.entity.ContentLengthStrategy
	{
		...
		public virtual long determineLength(org.apache.http.HttpMessage arg0)
		{
			...
			if (!IsClrObject)
				return @__env.CallLongMethod(this.JvmHandle, global::org.apache.http.impl.entity.StrictContentLengthStrategy._determineLength33377, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0));
			else
		...
		private static void InitJNI()
		{
			...
			global::org.apache.http.impl.entity.StrictContentLengthStrategy._determineLength33377 = @__env.GetMethodIDNoThrow(global::org.apache.http.impl.entity.StrictContentLengthStrategy.staticClass, "determineLength", "(Lorg/apache/http/HttpMessage;)J");
			global::org.apache.http.impl.entity.StrictContentLengthStrategy._StrictContentLengthStrategy33378 = @__env.GetMethodIDNoThrow(global::org.apache.http.impl.entity.StrictContentLengthStrategy.staticClass, "<init>", "()V");
		}
	}
}
