namespace org.apache.http.io
{
	...
	internal sealed partial class HttpMessageParser_ : java.lang.Object, HttpMessageParser
	{
		...
		global::org.apache.http.HttpMessage org.apache.http.io.HttpMessageParser.parse()
		{
			...
			if (!IsClrObject)
				return global::MonoJavaBridge.JavaBridge.WrapIJavaObject<global::org.apache.http.HttpMessage>(@__env.CallObjectMethod(this.JvmHandle, global::org.apache.http.io.HttpMessageParser_._parse33466)) as org.apache.http.HttpMessage;
			else
				return global::MonoJavaBridge.JavaBridge.WrapIJavaObject<global::org.apache.http.HttpMessage>(@__env.CallNonVirtualObjectMethod(this.JvmHandle, global::org.apache.http.io.HttpMessageParser_.staticClass, global::org.apache.http.io.HttpMessageParser_._parse33466)) as org.apache.http.HttpMessage;
		}
		private static void InitJNI()
		{
			...
			global::org.apache.http.io.HttpMessageParser_._parse33466 = @__env.GetMethodIDNoThrow(global::org.apache.http.io.HttpMessageParser_.staticClass, "parse", "()Lorg/apache/http/HttpMessage;");
		}
	}
}
