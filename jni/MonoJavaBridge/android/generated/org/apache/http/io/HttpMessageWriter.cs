namespace org.apache.http.io
{
	...
	public sealed partial class HttpMessageWriter_ : java.lang.Object, HttpMessageWriter
	{
		...
		internal static global::MonoJavaBridge.MethodId _write26722;
		 void org.apache.http.io.HttpMessageWriter.write(org.apache.http.HttpMessage arg0) 
		{
			global::MonoJavaBridge.JNIEnv @__env = global::MonoJavaBridge.JNIEnv.ThreadEnv;
			if (!IsClrObject)
				@__env.CallVoidMethod(this.JvmHandle, global::org.apache.http.io.HttpMessageWriter_._write26722, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0));
			else
				@__env.CallNonVirtualVoidMethod(this.JvmHandle, global::org.apache.http.io.HttpMessageWriter_.staticClass, global::org.apache.http.io.HttpMessageWriter_._write26722, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0));
		}
		private static void InitJNI()
		{
			...
			global::org.apache.http.io.HttpMessageWriter_._write26722 = @__env.GetMethodIDNoThrow(global::org.apache.http.io.HttpMessageWriter_.staticClass, "write", "(Lorg/apache/http/HttpMessage;)V");
		}
	}
}
