namespace org.apache.http.protocol
{
	...
	public sealed partial class HttpExpectationVerifier_ : java.lang.Object, HttpExpectationVerifier
	{
		...
		internal static global::MonoJavaBridge.MethodId _verify27090;
		 void org.apache.http.protocol.HttpExpectationVerifier.verify(org.apache.http.HttpRequest arg0, org.apache.http.HttpResponse arg1, org.apache.http.protocol.HttpContext arg2) 
		{
			...
			if (!IsClrObject)
				@__env.CallVoidMethod(this.JvmHandle, global::org.apache.http.protocol.HttpExpectationVerifier_._verify27090, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0), global::MonoJavaBridge.JavaBridge.ConvertToValue(arg1), global::MonoJavaBridge.JavaBridge.ConvertToValue(arg2));
			else
				@__env.CallNonVirtualVoidMethod(this.JvmHandle, global::org.apache.http.protocol.HttpExpectationVerifier_.staticClass, global::org.apache.http.protocol.HttpExpectationVerifier_._verify27090, global::MonoJavaBridge.JavaBridge.ConvertToValue(arg0), global::MonoJavaBridge.JavaBridge.ConvertToValue(arg1), global::MonoJavaBridge.JavaBridge.ConvertToValue(arg2));
		}
		private static void InitJNI()
		{
			...
			global::org.apache.http.protocol.HttpExpectationVerifier_._verify27090 = @__env.GetMethodIDNoThrow(global::org.apache.http.protocol.HttpExpectationVerifier_.staticClass, "verify", "(Lorg/apache/http/HttpRequest;Lorg/apache/http/HttpResponse;Lorg/apache/http/protocol/HttpContext;)V");
		}
	}
}
