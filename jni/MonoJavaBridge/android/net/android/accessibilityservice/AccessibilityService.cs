...
{ 
	...
	{ 
		...
		{ 
			global::net.sf.jni4net.utils.Registry.RegisterType(typeof(android.accessibilityservice.AccessibilityService), true, global::net.sf.jni4net.jni.JNIEnv.ThreadEnv); 
		} 
		...
		{ 
			...
			if (GetType() == typeof(android.accessibilityservice.AccessibilityService)) 
				@__env.CallVoidMethod(this, _onServiceConnected21); 
			else 
				@__env.CallNonVirtualVoidMethod(this, android.accessibilityservice.AccessibilityService.staticClass, _onServiceConnected21); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.accessibilityservice.AccessibilityService)) 
				@__env.CallVoidMethod(this, _setServiceInfo22, global::net.sf.jni4net.utils.Convertor.ParStrongCp2J(arg0)); 
			else 
				@__env.CallNonVirtualVoidMethod(this, android.accessibilityservice.AccessibilityService.staticClass, _setServiceInfo22, global::net.sf.jni4net.utils.Convertor.ParStrongCp2J(arg0)); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.accessibilityservice.AccessibilityService)) 
				return global::net.sf.jni4net.utils.Convertor.FullJ2C<android.os.IBinder>(@__env, @__env.CallObjectMethodPtr(this, _onBind23, global::net.sf.jni4net.utils.Convertor.ParStrongCp2J(arg0))); 
			else 
				return global::net.sf.jni4net.utils.Convertor.FullJ2C<android.os.IBinder>(@__env, @__env.CallNonVirtualObjectMethodPtr(this, android.accessibilityservice.AccessibilityService.staticClass, _onBind23, global::net.sf.jni4net.utils.Convertor.ParStrongCp2J(arg0))); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			@__env.NewObject(android.accessibilityservice.AccessibilityService.staticClass, _AccessibilityService24, this); 
		} 
