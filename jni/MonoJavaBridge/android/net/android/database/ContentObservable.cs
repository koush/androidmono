	...
	{ 
		...
		{ 
			...
			if (GetType() == typeof(android.database.ContentObservable)) 
				@__env.CallVoidMethod(this, _notifyChange2165, global::net.sf.jni4net.utils.Convertor.ParPrimC2J(arg0)); 
			else 
				@__env.CallNonVirtualVoidMethod(this, android.database.ContentObservable.staticClass, _notifyChange2165, global::net.sf.jni4net.utils.Convertor.ParPrimC2J(arg0)); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.database.ContentObservable)) 
				@__env.CallVoidMethod(this, _dispatchChange2166, global::net.sf.jni4net.utils.Convertor.ParPrimC2J(arg0)); 
			else 
				@__env.CallNonVirtualVoidMethod(this, android.database.ContentObservable.staticClass, _dispatchChange2166, global::net.sf.jni4net.utils.Convertor.ParPrimC2J(arg0)); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.database.ContentObservable)) 
				@__env.CallVoidMethod(this, _registerObserver2167, global::net.sf.jni4net.utils.Convertor.ParStrongCp2J(arg0)); 
			else 
				@__env.CallNonVirtualVoidMethod(this, android.database.ContentObservable.staticClass, _registerObserver2167, global::net.sf.jni4net.utils.Convertor.ParStrongCp2J(arg0)); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			@__env.NewObject(android.database.ContentObservable.staticClass, _ContentObservable2168, this); 
		} 
