	...
	{ 
		...
		{ 
			...
			if (GetType() == typeof(android.database.DataSetObserver)) 
				@__env.CallVoidMethod(this, _onChanged2338); 
			else 
				@__env.CallNonVirtualVoidMethod(this, android.database.DataSetObserver.staticClass, _onChanged2338); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.database.DataSetObserver)) 
				@__env.CallVoidMethod(this, _onInvalidated2339); 
			else 
				@__env.CallNonVirtualVoidMethod(this, android.database.DataSetObserver.staticClass, _onInvalidated2339); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			@__env.NewObject(android.database.DataSetObserver.staticClass, _DataSetObserver2340, this); 
		} 
