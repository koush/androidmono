	...
	{ 
		...
		{ 
			...
			if (GetType() == typeof(android.database.Observable)) 
				@__env.CallVoidMethod(this, _registerObserver2426, global::net.sf.jni4net.utils.Convertor.ParFullC2J(@__env, arg0)); 
			else 
				@__env.CallNonVirtualVoidMethod(this, android.database.Observable.staticClass, _registerObserver2426, global::net.sf.jni4net.utils.Convertor.ParFullC2J(@__env, arg0)); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.database.Observable)) 
				@__env.CallVoidMethod(this, _unregisterObserver2427, global::net.sf.jni4net.utils.Convertor.ParFullC2J(@__env, arg0)); 
			else 
				@__env.CallNonVirtualVoidMethod(this, android.database.Observable.staticClass, _unregisterObserver2427, global::net.sf.jni4net.utils.Convertor.ParFullC2J(@__env, arg0)); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.database.Observable)) 
				@__env.CallVoidMethod(this, _unregisterAll2428); 
			else 
				@__env.CallNonVirtualVoidMethod(this, android.database.Observable.staticClass, _unregisterAll2428); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			@__env.NewObject(android.database.Observable.staticClass, _Observable2429, this); 
		} 
