	...
	{ 
		...
		{ 
			...
			if (GetType() == typeof(android.database.sqlite.SQLiteClosable)) 
				@__env.CallVoidMethod(this, _onAllReferencesReleasedFromContainer2437); 
			else 
				@__env.CallNonVirtualVoidMethod(this, android.database.sqlite.SQLiteClosable.staticClass, _onAllReferencesReleasedFromContainer2437); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.database.sqlite.SQLiteClosable)) 
				@__env.CallVoidMethod(this, _acquireReference2438); 
			else 
				@__env.CallNonVirtualVoidMethod(this, android.database.sqlite.SQLiteClosable.staticClass, _acquireReference2438); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.database.sqlite.SQLiteClosable)) 
				@__env.CallVoidMethod(this, _releaseReference2439); 
			else 
				@__env.CallNonVirtualVoidMethod(this, android.database.sqlite.SQLiteClosable.staticClass, _releaseReference2439); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.database.sqlite.SQLiteClosable)) 
				@__env.CallVoidMethod(this, _releaseReferenceFromContainer2440); 
			else 
				@__env.CallNonVirtualVoidMethod(this, android.database.sqlite.SQLiteClosable.staticClass, _releaseReferenceFromContainer2440); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			@__env.NewObject(android.database.sqlite.SQLiteClosable.staticClass, _SQLiteClosable2441, this); 
		} 
