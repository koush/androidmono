	...
	{ 
		...
		{ 
			...
			if (GetType() == typeof(android.database.sqlite.SQLiteCursor)) 
				@__env.CallVoidMethod(this, _close2444); 
			else 
				@__env.CallNonVirtualVoidMethod(this, android.database.sqlite.SQLiteCursor.staticClass, _close2444); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.database.sqlite.SQLiteCursor)) 
				return @__env.CallIntMethod(this, _getCount2445); 
			else 
				return @__env.CallNonVirtualIntMethod(this, android.database.sqlite.SQLiteCursor.staticClass, _getCount2445); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.database.sqlite.SQLiteCursor)) 
				return @__env.CallIntMethod(this, _getColumnIndex2446, global::net.sf.jni4net.utils.Convertor.ParStrongCp2J(arg0)); 
			else 
				return @__env.CallNonVirtualIntMethod(this, android.database.sqlite.SQLiteCursor.staticClass, _getColumnIndex2446, global::net.sf.jni4net.utils.Convertor.ParStrongCp2J(arg0)); 
		} 
		internal static global::net.sf.jni4net.jni.MethodId _getColumnNames2447; 
		public override java.lang.String[] getColumnNames() 
		{ 
			if (GetType() == typeof(android.database.sqlite.SQLiteCursor)) 
				return null;//(@__env, @__env.CallObjectMethodPtr(this, _getColumnNames2447)); 
			else 
				return null;//(@__env, @__env.CallNonVirtualObjectMethodPtr(this, android.database.sqlite.SQLiteCursor.staticClass, _getColumnNames2447)); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.database.sqlite.SQLiteCursor)) 
				@__env.CallVoidMethod(this, _deactivate2448); 
			else 
				@__env.CallNonVirtualVoidMethod(this, android.database.sqlite.SQLiteCursor.staticClass, _deactivate2448); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.database.sqlite.SQLiteCursor)) 
				return @__env.CallBooleanMethod(this, _requery2449); 
			else 
				return @__env.CallNonVirtualBooleanMethod(this, android.database.sqlite.SQLiteCursor.staticClass, _requery2449); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.database.sqlite.SQLiteCursor)) 
				@__env.CallVoidMethod(this, _registerDataSetObserver2450, global::net.sf.jni4net.utils.Convertor.ParStrongCp2J(arg0)); 
			else 
				@__env.CallNonVirtualVoidMethod(this, android.database.sqlite.SQLiteCursor.staticClass, _registerDataSetObserver2450, global::net.sf.jni4net.utils.Convertor.ParStrongCp2J(arg0)); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.database.sqlite.SQLiteCursor)) 
				return @__env.CallBooleanMethod(this, _onMove2451, global::net.sf.jni4net.utils.Convertor.ParPrimC2J(arg0), global::net.sf.jni4net.utils.Convertor.ParPrimC2J(arg1)); 
			else 
				return @__env.CallNonVirtualBooleanMethod(this, android.database.sqlite.SQLiteCursor.staticClass, _onMove2451, global::net.sf.jni4net.utils.Convertor.ParPrimC2J(arg0), global::net.sf.jni4net.utils.Convertor.ParPrimC2J(arg1)); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.database.sqlite.SQLiteCursor)) 
				@__env.CallVoidMethod(this, _setWindow2452, global::net.sf.jni4net.utils.Convertor.ParStrongCp2J(arg0)); 
			else 
				@__env.CallNonVirtualVoidMethod(this, android.database.sqlite.SQLiteCursor.staticClass, _setWindow2452, global::net.sf.jni4net.utils.Convertor.ParStrongCp2J(arg0)); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.database.sqlite.SQLiteCursor)) 
				return global::net.sf.jni4net.utils.Convertor.StrongJ2Cp<android.database.sqlite.SQLiteDatabase>(@__env, @__env.CallObjectMethodPtr(this, _getDatabase2453)); 
			else 
				return global::net.sf.jni4net.utils.Convertor.StrongJ2Cp<android.database.sqlite.SQLiteDatabase>(@__env, @__env.CallNonVirtualObjectMethodPtr(this, android.database.sqlite.SQLiteCursor.staticClass, _getDatabase2453)); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.database.sqlite.SQLiteCursor)) 
				@__env.CallVoidMethod(this, _setSelectionArguments2454, global::net.sf.jni4net.utils.Convertor.ParArrayStrongCp2J(@__env, arg0)); 
			else 
				@__env.CallNonVirtualVoidMethod(this, android.database.sqlite.SQLiteCursor.staticClass, _setSelectionArguments2454, global::net.sf.jni4net.utils.Convertor.ParArrayStrongCp2J(@__env, arg0)); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			@__env.NewObject(android.database.sqlite.SQLiteCursor.staticClass, _SQLiteCursor2455, this, global::net.sf.jni4net.utils.Convertor.ParStrongCp2J(arg0), global::net.sf.jni4net.utils.Convertor.ParFullC2J(@__env, arg1), global::net.sf.jni4net.utils.Convertor.ParStrongCp2J(arg2), global::net.sf.jni4net.utils.Convertor.ParStrongCp2J(arg3)); 
		} 
