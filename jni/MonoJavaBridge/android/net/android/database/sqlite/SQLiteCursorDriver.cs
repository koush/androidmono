...
{ 
	...
	{ 
		...
		{ 
			global::net.sf.jni4net.utils.Registry.RegisterType(typeof(android.database.sqlite.__SQLiteCursorDriver), true, global::net.sf.jni4net.jni.JNIEnv.ThreadEnv); 
		} 
		...
		internal static global::net.sf.jni4net.jni.MethodId _query2456; 
		 android.database.Cursor android.database.sqlite.SQLiteCursorDriver.query(android.database.sqlite.SQLiteDatabase.CursorFactory arg0, java.lang.String[] arg1) 
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.database.sqlite.__SQLiteCursorDriver)) 
				return global::net.sf.jni4net.utils.Convertor.FullJ2C<android.database.Cursor>(@__env, @__env.CallObjectMethodPtr(this, _query2456, global::net.sf.jni4net.utils.Convertor.ParFullC2J(@__env, arg0), global::net.sf.jni4net.utils.Convertor.ParArrayStrongCp2J(@__env, arg1))); 
			else 
				return global::net.sf.jni4net.utils.Convertor.FullJ2C<android.database.Cursor>(@__env, @__env.CallNonVirtualObjectMethodPtr(this, android.database.sqlite.__SQLiteCursorDriver.staticClass, _query2456, global::net.sf.jni4net.utils.Convertor.ParFullC2J(@__env, arg0), global::net.sf.jni4net.utils.Convertor.ParArrayStrongCp2J(@__env, arg1))); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.database.sqlite.__SQLiteCursorDriver)) 
				@__env.CallVoidMethod(this, _cursorDeactivated2457); 
			else 
				@__env.CallNonVirtualVoidMethod(this, android.database.sqlite.__SQLiteCursorDriver.staticClass, _cursorDeactivated2457); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.database.sqlite.__SQLiteCursorDriver)) 
				@__env.CallVoidMethod(this, _cursorRequeried2458, global::net.sf.jni4net.utils.Convertor.ParFullC2J(@__env, arg0)); 
			else 
				@__env.CallNonVirtualVoidMethod(this, android.database.sqlite.__SQLiteCursorDriver.staticClass, _cursorRequeried2458, global::net.sf.jni4net.utils.Convertor.ParFullC2J(@__env, arg0)); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.database.sqlite.__SQLiteCursorDriver)) 
				@__env.CallVoidMethod(this, _cursorClosed2459); 
			else 
				@__env.CallNonVirtualVoidMethod(this, android.database.sqlite.__SQLiteCursorDriver.staticClass, _cursorClosed2459); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.database.sqlite.__SQLiteCursorDriver)) 
				@__env.CallVoidMethod(this, _setBindArguments2460, global::net.sf.jni4net.utils.Convertor.ParArrayStrongCp2J(@__env, arg0)); 
			else 
				@__env.CallNonVirtualVoidMethod(this, android.database.sqlite.__SQLiteCursorDriver.staticClass, _setBindArguments2460, global::net.sf.jni4net.utils.Convertor.ParArrayStrongCp2J(@__env, arg0)); 
		} 
