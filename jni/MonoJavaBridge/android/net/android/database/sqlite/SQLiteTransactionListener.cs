...
{ 
	...
	{ 
		...
		{ 
			global::net.sf.jni4net.utils.Registry.RegisterType(typeof(android.database.sqlite.__SQLiteTransactionListener), true, global::net.sf.jni4net.jni.JNIEnv.ThreadEnv); 
		} 
		...
		{ 
			...
			if (GetType() == typeof(android.database.sqlite.__SQLiteTransactionListener)) 
				@__env.CallVoidMethod(this, _onBegin2572); 
			else 
				@__env.CallNonVirtualVoidMethod(this, android.database.sqlite.__SQLiteTransactionListener.staticClass, _onBegin2572); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.database.sqlite.__SQLiteTransactionListener)) 
				@__env.CallVoidMethod(this, _onCommit2573); 
			else 
				@__env.CallNonVirtualVoidMethod(this, android.database.sqlite.__SQLiteTransactionListener.staticClass, _onCommit2573); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.database.sqlite.__SQLiteTransactionListener)) 
				@__env.CallVoidMethod(this, _onRollback2574); 
			else 
				@__env.CallNonVirtualVoidMethod(this, android.database.sqlite.__SQLiteTransactionListener.staticClass, _onRollback2574); 
		} 
