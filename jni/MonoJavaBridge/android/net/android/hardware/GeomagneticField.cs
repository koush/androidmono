	...
	{ 
		...
		{ 
			...
			if (GetType() == typeof(android.hardware.GeomagneticField)) 
				return @__env.CallFloatMethod(this, _getY3922); 
			else 
				return @__env.CallNonVirtualFloatMethod(this, android.hardware.GeomagneticField.staticClass, _getY3922); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.hardware.GeomagneticField)) 
				return @__env.CallFloatMethod(this, _getX3923); 
			else 
				return @__env.CallNonVirtualFloatMethod(this, android.hardware.GeomagneticField.staticClass, _getX3923); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.hardware.GeomagneticField)) 
				return @__env.CallFloatMethod(this, _getZ3924); 
			else 
				return @__env.CallNonVirtualFloatMethod(this, android.hardware.GeomagneticField.staticClass, _getZ3924); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.hardware.GeomagneticField)) 
				return @__env.CallFloatMethod(this, _getDeclination3925); 
			else 
				return @__env.CallNonVirtualFloatMethod(this, android.hardware.GeomagneticField.staticClass, _getDeclination3925); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.hardware.GeomagneticField)) 
				return @__env.CallFloatMethod(this, _getInclination3926); 
			else 
				return @__env.CallNonVirtualFloatMethod(this, android.hardware.GeomagneticField.staticClass, _getInclination3926); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.hardware.GeomagneticField)) 
				return @__env.CallFloatMethod(this, _getHorizontalStrength3927); 
			else 
				return @__env.CallNonVirtualFloatMethod(this, android.hardware.GeomagneticField.staticClass, _getHorizontalStrength3927); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.hardware.GeomagneticField)) 
				return @__env.CallFloatMethod(this, _getFieldStrength3928); 
			else 
				return @__env.CallNonVirtualFloatMethod(this, android.hardware.GeomagneticField.staticClass, _getFieldStrength3928); 
		} 
