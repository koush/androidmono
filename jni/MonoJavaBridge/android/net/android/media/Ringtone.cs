	...
	{ 
		...
		{ 
			...
			if (GetType() == typeof(android.media.Ringtone)) 
				@__env.CallVoidMethod(this, _stop4566); 
			else 
				@__env.CallNonVirtualVoidMethod(this, android.media.Ringtone.staticClass, _stop4566); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.media.Ringtone)) 
				return global::net.sf.jni4net.utils.Convertor.StrongJ2Cp<java.lang.String>(@__env, @__env.CallObjectMethodPtr(this, _getTitle4567, global::net.sf.jni4net.utils.Convertor.ParStrongCp2J(arg0))); 
			else 
				return global::net.sf.jni4net.utils.Convertor.StrongJ2Cp<java.lang.String>(@__env, @__env.CallNonVirtualObjectMethodPtr(this, android.media.Ringtone.staticClass, _getTitle4567, global::net.sf.jni4net.utils.Convertor.ParStrongCp2J(arg0))); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.media.Ringtone)) 
				@__env.CallVoidMethod(this, _play4568); 
			else 
				@__env.CallNonVirtualVoidMethod(this, android.media.Ringtone.staticClass, _play4568); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.media.Ringtone)) 
				return @__env.CallIntMethod(this, _getStreamType4569); 
			else 
				return @__env.CallNonVirtualIntMethod(this, android.media.Ringtone.staticClass, _getStreamType4569); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.media.Ringtone)) 
				return @__env.CallBooleanMethod(this, _isPlaying4570); 
			else 
				return @__env.CallNonVirtualBooleanMethod(this, android.media.Ringtone.staticClass, _isPlaying4570); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.media.Ringtone)) 
				@__env.CallVoidMethod(this, _setStreamType4571, global::net.sf.jni4net.utils.Convertor.ParPrimC2J(arg0)); 
			else 
				@__env.CallNonVirtualVoidMethod(this, android.media.Ringtone.staticClass, _setStreamType4571, global::net.sf.jni4net.utils.Convertor.ParPrimC2J(arg0)); 
		} 
