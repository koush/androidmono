	...
	{ 
		...
		{ 
			...
			if (GetType() == typeof(android.os.ConditionVariable)) 
				@__env.CallVoidMethod(this, _close5474); 
			else 
				@__env.CallNonVirtualVoidMethod(this, android.os.ConditionVariable.staticClass, _close5474); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.os.ConditionVariable)) 
				@__env.CallVoidMethod(this, _open5475); 
			else 
				@__env.CallNonVirtualVoidMethod(this, android.os.ConditionVariable.staticClass, _open5475); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.os.ConditionVariable)) 
				@__env.CallVoidMethod(this, _block5476); 
			else 
				@__env.CallNonVirtualVoidMethod(this, android.os.ConditionVariable.staticClass, _block5476); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.os.ConditionVariable)) 
				return @__env.CallBooleanMethod(this, _block5477, global::net.sf.jni4net.utils.Convertor.ParPrimC2J(arg0)); 
			else 
				return @__env.CallNonVirtualBooleanMethod(this, android.os.ConditionVariable.staticClass, _block5477, global::net.sf.jni4net.utils.Convertor.ParPrimC2J(arg0)); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			@__env.NewObject(android.os.ConditionVariable.staticClass, _ConditionVariable5478, this); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			@__env.NewObject(android.os.ConditionVariable.staticClass, _ConditionVariable5479, this, global::net.sf.jni4net.utils.Convertor.ParPrimC2J(arg0)); 
		} 
