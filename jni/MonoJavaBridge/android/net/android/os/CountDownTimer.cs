	...
	{ 
		...
		{ 
			...
			if (GetType() == typeof(android.os.CountDownTimer)) 
				return global::net.sf.jni4net.utils.Convertor.StrongJ2Cp<android.os.CountDownTimer>(@__env, @__env.CallObjectMethodPtr(this, _start5480)); 
			else 
				return global::net.sf.jni4net.utils.Convertor.StrongJ2Cp<android.os.CountDownTimer>(@__env, @__env.CallNonVirtualObjectMethodPtr(this, android.os.CountDownTimer.staticClass, _start5480)); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.os.CountDownTimer)) 
				@__env.CallVoidMethod(this, _cancel5481); 
			else 
				@__env.CallNonVirtualVoidMethod(this, android.os.CountDownTimer.staticClass, _cancel5481); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			@__env.NewObject(android.os.CountDownTimer.staticClass, _CountDownTimer5484, this, global::net.sf.jni4net.utils.Convertor.ParPrimC2J(arg0), global::net.sf.jni4net.utils.Convertor.ParPrimC2J(arg1)); 
		} 
