	...
	{ 
		...
		{ 
			...
			if (GetType() == typeof(android.sax.RootElement)) 
				return global::net.sf.jni4net.utils.Convertor.FullJ2C<org.xml.sax.ContentHandler>(@__env, @__env.CallObjectMethodPtr(this, _getContentHandler6388)); 
			else 
				return global::net.sf.jni4net.utils.Convertor.FullJ2C<org.xml.sax.ContentHandler>(@__env, @__env.CallNonVirtualObjectMethodPtr(this, android.sax.RootElement.staticClass, _getContentHandler6388)); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			@__env.NewObject(android.sax.RootElement.staticClass, _RootElement6389, this, global::net.sf.jni4net.utils.Convertor.ParStrongCp2J(arg0), global::net.sf.jni4net.utils.Convertor.ParStrongCp2J(arg1)); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			@__env.NewObject(android.sax.RootElement.staticClass, _RootElement6390, this, global::net.sf.jni4net.utils.Convertor.ParStrongCp2J(arg0)); 
		} 
