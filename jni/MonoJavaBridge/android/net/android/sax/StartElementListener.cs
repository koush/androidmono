...
{ 
	...
	{ 
		...
		{ 
			global::net.sf.jni4net.utils.Registry.RegisterType(typeof(android.sax.__StartElementListener), true, global::net.sf.jni4net.jni.JNIEnv.ThreadEnv); 
		} 
		...
		{ 
			...
			if (GetType() == typeof(android.sax.__StartElementListener)) 
				@__env.CallVoidMethod(this, _start6391, global::net.sf.jni4net.utils.Convertor.ParFullC2J(@__env, arg0)); 
			else 
				@__env.CallNonVirtualVoidMethod(this, android.sax.__StartElementListener.staticClass, _start6391, global::net.sf.jni4net.utils.Convertor.ParFullC2J(@__env, arg0)); 
		} 
