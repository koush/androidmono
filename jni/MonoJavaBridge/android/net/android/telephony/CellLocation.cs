...
{ 
	...
	{ 
		...
		{ 
			...
			@__env.CallStaticVoidMethod(android.telephony.CellLocation.staticClass, _requestLocationUpdate6437); 
		} 
		internal static global::net.sf.jni4net.jni.MethodId _getEmpty6438; 
		public static android.telephony.CellLocation getEmpty() 
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			return global::net.sf.jni4net.utils.Convertor.StrongJ2Cp<android.telephony.CellLocation>(@__env, @__env.CallStaticObjectMethodPtr(android.telephony.CellLocation.staticClass, _getEmpty6438)); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			@__env.NewObject(android.telephony.CellLocation.staticClass, _CellLocation6439, this); 
		} 
