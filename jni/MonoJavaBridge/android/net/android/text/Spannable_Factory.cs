...
{ 
	...
	{ 
		...
		{ 
			...
			return global::net.sf.jni4net.utils.Convertor.StrongJ2Cp<android.text.Spannable_Factory>(@__env, @__env.CallStaticObjectMethodPtr(android.text.Spannable_Factory.staticClass, _getInstance6885)); 
		} 
		...
		{ 
			...
			if (GetType() == typeof(android.text.Spannable_Factory)) 
				return global::net.sf.jni4net.utils.Convertor.FullJ2C<android.text.Spannable>(@__env, @__env.CallObjectMethodPtr(this, _newSpannable6886, global::net.sf.jni4net.utils.Convertor.ParFullC2J(@__env, arg0))); 
			else 
				return global::net.sf.jni4net.utils.Convertor.FullJ2C<android.text.Spannable>(@__env, @__env.CallNonVirtualObjectMethodPtr(this, android.text.Spannable_Factory.staticClass, _newSpannable6886, global::net.sf.jni4net.utils.Convertor.ParFullC2J(@__env, arg0))); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			@__env.NewObject(android.text.Spannable_Factory.staticClass, _Spannable_Factory6887, this); 
		} 
