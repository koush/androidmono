...
{ 
	...
	{ 
		...
		{ 
			...
			return global::net.sf.jni4net.utils.Convertor.StrongJ2Cp<android.text.method.TimeKeyListener>(@__env, @__env.CallStaticObjectMethodPtr(android.text.method.TimeKeyListener.staticClass, _getInstance7266)); 
		} 
		...
		{ 
			...
			if (GetType() == typeof(android.text.method.TimeKeyListener)) 
				return @__env.CallIntMethod(this, _getInputType7267); 
			else 
				return @__env.CallNonVirtualIntMethod(this, android.text.method.TimeKeyListener.staticClass, _getInputType7267); 
		} 
		internal static global::net.sf.jni4net.jni.MethodId _getAcceptedChars7268; 
		protected override char[] getAcceptedChars() 
		{ 
			if (GetType() == typeof(android.text.method.TimeKeyListener)) 
				return null;//(@__env, @__env.CallObjectMethodPtr(this, _getAcceptedChars7268)); 
			else 
				return null;//(@__env, @__env.CallNonVirtualObjectMethodPtr(this, android.text.method.TimeKeyListener.staticClass, _getAcceptedChars7268)); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			@__env.NewObject(android.text.method.TimeKeyListener.staticClass, _TimeKeyListener7269, this); 
		} 
