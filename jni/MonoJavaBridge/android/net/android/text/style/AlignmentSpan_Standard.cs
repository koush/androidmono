	...
	{ 
		...
		{ 
			...
			if (GetType() == typeof(android.text.style.AlignmentSpan_Standard)) 
				@__env.CallVoidMethod(this, _writeToParcel7287, global::net.sf.jni4net.utils.Convertor.ParStrongCp2J(arg0), global::net.sf.jni4net.utils.Convertor.ParPrimC2J(arg1)); 
			else 
				@__env.CallNonVirtualVoidMethod(this, android.text.style.AlignmentSpan_Standard.staticClass, _writeToParcel7287, global::net.sf.jni4net.utils.Convertor.ParStrongCp2J(arg0), global::net.sf.jni4net.utils.Convertor.ParPrimC2J(arg1)); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.text.style.AlignmentSpan_Standard)) 
				return @__env.CallIntMethod(this, _describeContents7288); 
			else 
				return @__env.CallNonVirtualIntMethod(this, android.text.style.AlignmentSpan_Standard.staticClass, _describeContents7288); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.text.style.AlignmentSpan_Standard)) 
				return global::net.sf.jni4net.utils.Convertor.StrongJ2Cp<android.text.Layout.Alignment>(@__env, @__env.CallObjectMethodPtr(this, _getAlignment7289)); 
			else 
				return global::net.sf.jni4net.utils.Convertor.StrongJ2Cp<android.text.Layout.Alignment>(@__env, @__env.CallNonVirtualObjectMethodPtr(this, android.text.style.AlignmentSpan_Standard.staticClass, _getAlignment7289)); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.text.style.AlignmentSpan_Standard)) 
				return @__env.CallIntMethod(this, _getSpanTypeId7290); 
			else 
				return @__env.CallNonVirtualIntMethod(this, android.text.style.AlignmentSpan_Standard.staticClass, _getSpanTypeId7290); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			@__env.NewObject(android.text.style.AlignmentSpan_Standard.staticClass, _AlignmentSpan_Standard7291, this, global::net.sf.jni4net.utils.Convertor.ParStrongCp2J(arg0)); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			@__env.NewObject(android.text.style.AlignmentSpan_Standard.staticClass, _AlignmentSpan_Standard7292, this, global::net.sf.jni4net.utils.Convertor.ParStrongCp2J(arg0)); 
		} 
