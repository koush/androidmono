	...
	{ 
		...
		{ 
			...
			if (GetType() == typeof(android.text.style.BackgroundColorSpan)) 
				@__env.CallVoidMethod(this, _writeToParcel7294, global::net.sf.jni4net.utils.Convertor.ParStrongCp2J(arg0), global::net.sf.jni4net.utils.Convertor.ParPrimC2J(arg1)); 
			else 
				@__env.CallNonVirtualVoidMethod(this, android.text.style.BackgroundColorSpan.staticClass, _writeToParcel7294, global::net.sf.jni4net.utils.Convertor.ParStrongCp2J(arg0), global::net.sf.jni4net.utils.Convertor.ParPrimC2J(arg1)); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.text.style.BackgroundColorSpan)) 
				return @__env.CallIntMethod(this, _describeContents7295); 
			else 
				return @__env.CallNonVirtualIntMethod(this, android.text.style.BackgroundColorSpan.staticClass, _describeContents7295); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.text.style.BackgroundColorSpan)) 
				return @__env.CallIntMethod(this, _getSpanTypeId7296); 
			else 
				return @__env.CallNonVirtualIntMethod(this, android.text.style.BackgroundColorSpan.staticClass, _getSpanTypeId7296); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.text.style.BackgroundColorSpan)) 
				@__env.CallVoidMethod(this, _updateDrawState7297, global::net.sf.jni4net.utils.Convertor.ParStrongCp2J(arg0)); 
			else 
				@__env.CallNonVirtualVoidMethod(this, android.text.style.BackgroundColorSpan.staticClass, _updateDrawState7297, global::net.sf.jni4net.utils.Convertor.ParStrongCp2J(arg0)); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.text.style.BackgroundColorSpan)) 
				return @__env.CallIntMethod(this, _getBackgroundColor7298); 
			else 
				return @__env.CallNonVirtualIntMethod(this, android.text.style.BackgroundColorSpan.staticClass, _getBackgroundColor7298); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			@__env.NewObject(android.text.style.BackgroundColorSpan.staticClass, _BackgroundColorSpan7299, this, global::net.sf.jni4net.utils.Convertor.ParPrimC2J(arg0)); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			@__env.NewObject(android.text.style.BackgroundColorSpan.staticClass, _BackgroundColorSpan7300, this, global::net.sf.jni4net.utils.Convertor.ParStrongCp2J(arg0)); 
		} 
