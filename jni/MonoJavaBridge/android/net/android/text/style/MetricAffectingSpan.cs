	...
	{ 
		...
		{ 
			...
			if (GetType() == typeof(android.text.style.MetricAffectingSpan)) 
				return global::net.sf.jni4net.utils.Convertor.StrongJ2Cp<android.text.style.MetricAffectingSpan>(@__env, @__env.CallObjectMethodPtr(this, _getUnderlying7371)); 
			else 
				return global::net.sf.jni4net.utils.Convertor.StrongJ2Cp<android.text.style.MetricAffectingSpan>(@__env, @__env.CallNonVirtualObjectMethodPtr(this, android.text.style.MetricAffectingSpan.staticClass, _getUnderlying7371)); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			@__env.NewObject(android.text.style.MetricAffectingSpan.staticClass, _MetricAffectingSpan7373, this); 
		} 
