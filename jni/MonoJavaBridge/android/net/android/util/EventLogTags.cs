...
{ 
	...
	{ 
		...
		static EventLogTags() 
		{ 
			global::net.sf.jni4net.utils.Registry.RegisterType(typeof(android.util.EventLogTags), true, global::net.sf.jni4net.jni.JNIEnv.ThreadEnv); 
		} 
		...
		{ 
			...
			static Description() 
			{ 
				global::net.sf.jni4net.utils.Registry.RegisterType(typeof(android.util.EventLogTags.Description), true, global::net.sf.jni4net.jni.JNIEnv.ThreadEnv); 
			} 
			private sealed class ContructionHelper : global::net.sf.jni4net.utils.IConstructionHelper 
			{ 
				public global::net.sf.jni4net.jni.IJvmProxy CreateProxy(global::net.sf.jni4net.jni.JNIEnv @__env) 
