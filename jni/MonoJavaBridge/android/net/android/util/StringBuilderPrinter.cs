	...
	{ 
		...
		{ 
			...
			if (GetType() == typeof(android.util.StringBuilderPrinter)) 
				@__env.CallVoidMethod(this, _println7647, global::net.sf.jni4net.utils.Convertor.ParStrongCp2J(arg0)); 
			else 
				@__env.CallNonVirtualVoidMethod(this, android.util.StringBuilderPrinter.staticClass, _println7647, global::net.sf.jni4net.utils.Convertor.ParStrongCp2J(arg0)); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			@__env.NewObject(android.util.StringBuilderPrinter.staticClass, _StringBuilderPrinter7648, this, global::net.sf.jni4net.utils.Convertor.ParStrongCp2J(arg0)); 
		} 
