	...
	{ 
		...
		{ 
			...
			if (GetType() == typeof(android.view.OrientationEventListener)) 
				@__env.CallVoidMethod(this, _enable7981); 
			else 
				@__env.CallNonVirtualVoidMethod(this, android.view.OrientationEventListener.staticClass, _enable7981); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.view.OrientationEventListener)) 
				@__env.CallVoidMethod(this, _disable7982); 
			else 
				@__env.CallNonVirtualVoidMethod(this, android.view.OrientationEventListener.staticClass, _disable7982); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(android.view.OrientationEventListener)) 
				return @__env.CallBooleanMethod(this, _canDetectOrientation7983); 
			else 
				return @__env.CallNonVirtualBooleanMethod(this, android.view.OrientationEventListener.staticClass, _canDetectOrientation7983); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			@__env.NewObject(android.view.OrientationEventListener.staticClass, _OrientationEventListener7985, this, global::net.sf.jni4net.utils.Convertor.ParStrongCp2J(arg0)); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			@__env.NewObject(android.view.OrientationEventListener.staticClass, _OrientationEventListener7986, this, global::net.sf.jni4net.utils.Convertor.ParStrongCp2J(arg0), global::net.sf.jni4net.utils.Convertor.ParPrimC2J(arg1)); 
		} 
