...
{ 
	...
	{ 
		...
		{ 
			...
			return global::net.sf.jni4net.utils.Convertor.StrongJ2Cp<java.nio.channels.ServerSocketChannel>(@__env, @__env.CallStaticObjectMethodPtr(java.nio.channels.ServerSocketChannel.staticClass, _open12275)); 
		} 
		...
		{ 
			...
			if (GetType() == typeof(java.nio.channels.ServerSocketChannel)) 
				return @__env.CallIntMethod(this, _validOps12277); 
			else 
				return @__env.CallNonVirtualIntMethod(this, java.nio.channels.ServerSocketChannel.staticClass, _validOps12277); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			@__env.NewObject(java.nio.channels.ServerSocketChannel.staticClass, _ServerSocketChannel12278, this, global::net.sf.jni4net.utils.Convertor.ParStrongCp2J(arg0)); 
		} 
