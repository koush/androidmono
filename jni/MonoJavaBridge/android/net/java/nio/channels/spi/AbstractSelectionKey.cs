	...
	{ 
		...
		{ 
			...
			if (GetType() == typeof(java.nio.channels.spi.AbstractSelectionKey)) 
				return @__env.CallBooleanMethod(this, _isValid12315); 
			else 
				return @__env.CallNonVirtualBooleanMethod(this, java.nio.channels.spi.AbstractSelectionKey.staticClass, _isValid12315); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(java.nio.channels.spi.AbstractSelectionKey)) 
				@__env.CallVoidMethod(this, _cancel12316); 
			else 
				@__env.CallNonVirtualVoidMethod(this, java.nio.channels.spi.AbstractSelectionKey.staticClass, _cancel12316); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			@__env.NewObject(java.nio.channels.spi.AbstractSelectionKey.staticClass, _AbstractSelectionKey12317, this); 
		} 
