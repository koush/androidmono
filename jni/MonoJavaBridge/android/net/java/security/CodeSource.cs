	...
	{ 
		...
		{ 
			...
			if (GetType() == typeof(java.security.CodeSource)) 
				return @__env.CallIntMethod(this, _hashCode12427); 
			else 
				return @__env.CallNonVirtualIntMethod(this, java.security.CodeSource.staticClass, _hashCode12427); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(java.security.CodeSource)) 
				return @__env.CallBooleanMethod(this, _equals12428, global::net.sf.jni4net.utils.Convertor.ParFullC2J(@__env, arg0)); 
			else 
				return @__env.CallNonVirtualBooleanMethod(this, java.security.CodeSource.staticClass, _equals12428, global::net.sf.jni4net.utils.Convertor.ParFullC2J(@__env, arg0)); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(java.security.CodeSource)) 
				return global::net.sf.jni4net.utils.Convertor.StrongJ2Cp<java.lang.String>(@__env, @__env.CallObjectMethodPtr(this, _toString12429)); 
			else 
				return global::net.sf.jni4net.utils.Convertor.StrongJ2Cp<java.lang.String>(@__env, @__env.CallNonVirtualObjectMethodPtr(this, java.security.CodeSource.staticClass, _toString12429)); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(java.security.CodeSource)) 
				return global::net.sf.jni4net.utils.Convertor.StrongJ2Cp<java.net.URL>(@__env, @__env.CallObjectMethodPtr(this, _getLocation12430)); 
			else 
				return global::net.sf.jni4net.utils.Convertor.StrongJ2Cp<java.net.URL>(@__env, @__env.CallNonVirtualObjectMethodPtr(this, java.security.CodeSource.staticClass, _getLocation12430)); 
		} 
		...
		{ 
			if (GetType() == typeof(java.security.CodeSource)) 
				return null;//(@__env, @__env.CallObjectMethodPtr(this, _getCertificates12431)); 
			else 
				return null;//(@__env, @__env.CallNonVirtualObjectMethodPtr(this, java.security.CodeSource.staticClass, _getCertificates12431)); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			if (GetType() == typeof(java.security.CodeSource)) 
				return @__env.CallBooleanMethod(this, _implies12432, global::net.sf.jni4net.utils.Convertor.ParStrongCp2J(arg0)); 
			else 
				return @__env.CallNonVirtualBooleanMethod(this, java.security.CodeSource.staticClass, _implies12432, global::net.sf.jni4net.utils.Convertor.ParStrongCp2J(arg0)); 
		} 
		...
		{ 
			if (GetType() == typeof(java.security.CodeSource)) 
				return null;//(@__env, @__env.CallObjectMethodPtr(this, _getCodeSigners12433)); 
			else 
				return null;//(@__env, @__env.CallNonVirtualObjectMethodPtr(this, java.security.CodeSource.staticClass, _getCodeSigners12433)); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			@__env.NewObject(java.security.CodeSource.staticClass, _CodeSource12434, this, global::net.sf.jni4net.utils.Convertor.ParStrongCp2J(arg0), global::net.sf.jni4net.utils.Convertor.ParArrayStrongCp2J(@__env, arg1)); 
		} 
		...
		{ 
			global::net.sf.jni4net.jni.JNIEnv @__env = global::net.sf.jni4net.jni.JNIEnv.ThreadEnv; 
			@__env.NewObject(java.security.CodeSource.staticClass, _CodeSource12435, this, global::net.sf.jni4net.utils.Convertor.ParStrongCp2J(arg0), global::net.sf.jni4net.utils.Convertor.ParArrayStrongCp2J(@__env, arg1)); 
		} 
