...
{ 
	...
	{ 
		...
		static __Guard() 
		{ 
			global::net.sf.jni4net.utils.Registry.RegisterType(typeof(java.security.__Guard), true, global::net.sf.jni4net.jni.JNIEnv.ThreadEnv); 
		} 
		...
		{ 
			...
			if (GetType() == typeof(java.security.__Guard)) 
				@__env.CallVoidMethod(this, _checkGuard12436, global::net.sf.jni4net.utils.Convertor.ParFullC2J(@__env, arg0)); 
			else 
				@__env.CallNonVirtualVoidMethod(this, java.security.__Guard.staticClass, _checkGuard12436, global::net.sf.jni4net.utils.Convertor.ParFullC2J(@__env, arg0)); 
		} 
